...
export const otherCs: MenuItem[] = [
  ...
  { href: '/tyrovsti-z-einsiedlu/synove-jindrichovi' },
  { href: '/tyrovsti-z-einsiedlu/jan-tyrovsky-z-einsiedlu' },
  { href: '/tyrovsti-z-einsiedlu/jindrich-jakub-tyrovsky-z-einsiedlu' },
  { href: '/tyrovsti-z-einsiedlu/adam-jindrich-tyrovsky-z-einsiedlu' },
  { href: '/tyrovsti-z-einsiedlu/vojtech-ignac-tyrovsky-z-einsiedlu' },
  { href: '/tyrovsti-z-einsiedlu/posledni-tyrovsti' },
...
export const otherEn: MenuItem[] = [
  ...
  { href: '/tyrovsky-of-einsiedl/sons-of-henry' },
  { href: '/tyrovsky-of-einsiedl/john-of-einsiedl' },
  { href: '/tyrovsky-of-einsiedl/henry-jacob-of-einsiedl' },
  { href: '/tyrovsky-of-einsiedl/adam-henry-of-einsiedl' },
  { href: '/tyrovsky-of-einsiedl/adalbert-ignatius-of-einsiedl' },
  { href: '/tyrovsky-of-einsiedl/the-last-tyrovsky' },
...
export const otherDe: MenuItem[] = [
  ...
  { href: '/tyrovsky-von-einsiedl/soehne-heinrichs' },
  { href: '/tyrovsky-von-einsiedl/johann-von-einsiedl' },
  { href: '/tyrovsky-von-einsiedl/heinrich-jakob-von-einsiedl' },
  { href: '/tyrovsky-von-einsiedl/adam-heinrich-von-einsiedl' },
  { href: '/tyrovsky-von-einsiedl/adalbert-ignaz-von-einsiedl' },
  { href: '/tyrovsky-von-einsiedl/die-letzten-tyrovsky' },
...
export const otherIt: MenuItem[] = [
  ...
  { href: '/tyrovsky-di-einsiedl/figli-di-enrico' },
  { href: '/tyrovsky-di-einsiedl/giovanni-di-einsiedl' },
  { href: '/tyrovsky-di-einsiedl/enrico-giacomo-di-einsiedl' },
  { href: '/tyrovsky-di-einsiedl/adamo-enrico-di-einsiedl' },
  { href: '/tyrovsky-di-einsiedl/adalberto-ignazio-di-einsiedl' },
  { href: '/tyrovsky-di-einsiedl/gli-ultimi-tyrovsky' },
