...
export const AdamHenryOfEinsiedl = () => (
  <>
    <Row>
      <Col>
        <div className="anchor" id="adam-henry-of-einsiedl" />
        <h4>Adam Jindřich (Adam Henry) Týřovský of Einsiedl (died 1652)</h4>
        <p>
          Adam Jindřich was a minor at his father&apos;s death in 1618, which
          probably saved him. In 1621 he was indeed summoned before the
          confiscation commission, but because he was not of legal age he did
          not appear to a twofold summons; only in 1629 was he acquitted before
          the commissio tractationis, since he had not personally taken part in
          the revolt, and his father&apos;s estates of Chříč, Hřebečníky, Broumy
          and Kožlany were left to him.
          <Qt
        ...
        <p>
          In the meantime his guardian Bohuslav Jiří Krakovský managed Chříč
          badly. In 1624 Dorota Týřovská sued him for impoverishing the orphans,
          for carrying off and selling grain, cattle and other things.
          <Qt
            publication={PUBLICATIONS.KOCKA1}
            href="https://kramerius5.nkp.cz/view/uuid:cbd24070-4608-11ed-b64c-005056827e52?page=uuid:7e24d610-e020-4b49-94be-10a7485249aa"
            note="p. 314–315"
        ...
        <p>
          In 1627 Adam Jindřich came of age and took possession of the indebted
          estates; he managed them with his official Václav Kulíšek. In order to
          be able to cultivate the devastated estate, he borrowed 2,800 schocks
          from Vilém of Klenové at Zvíkovec. When the term expired in 1631 and
        ...
        <p>
          In the same year 1631 the Saxons burst into Rakovník, and Týřovský was
          subsequently accused of having welcomed Captain Ploskovský on the
          square, of having engaged himself to him as a cavalry captain, of
          riding about the district with his wife, supplying the Saxons with
          news, skirmishing with the imperial troops and threatening Catholic
          Plzeň. The burghers of Rakovník, on the contrary, testified that he
        ...
        <p>
          The war rolled over Chříč twice more. In 1637 enemy armies were
          ranging through the neighbourhood and burned Chříč, so that Adam
          Jindřich stayed in Prague, where he bought a house from the tax
          registrar Kačerovský. In March 1640 the imperial colonel Václav
          Zahrádecký marched with two regiments to Podmokly, burned everything
          and pressed on across the ford towards Chříč; Týřovský raised 300
          guilders for the fire ransom and thus rid himself of the enemy.
          <Qt
            publication={PUBLICATIONS.KOCKA1}
            href="https://kramerius5.nkp.cz/view/uuid:cbd24070-4608-11ed-b64c-005056827e52?page=uuid:7c883e9c-c039-4e28-8217-2e3df2340137"
            note="p. 315"
