  ...
  <>
    <Row>
      <Col>
        ...
        <p>
          ...
          the first written Czech military order. Through the song, the
          soldiers, often illiterate, instilled warrior principles, which then
          appeared in the in later orders:
          <br />
          1th - 4th stanza exhort to faith in God, His will and grace.
          <br />
          5th stanza - do not be anxious for the number and do not flee from the
          battle. <br />
    ...
    <Row>
      <Col md={6}>
        ...
        <p>
          ...
          <br />a przed neprzately neutiekayte
        </p>
        <p>
        ...
        <p>
          ...
          <br />
          źywotow netratьte
          <br />a na korzystech se nezastawuyte
        </p>
        <p>
      ...
      <Col md={6}>
        <p>
          <b>Ye Who Are Warriors of God</b>
          <br />
          <br />
        </p>
        <p>
    ...
    <Row>
      <Col className="text-center">
        ...
        <audio controls>
          <source src="/sounds/Ktoz_jsu_bozi_bojovnici.mp3" type="audio/mpeg" />
