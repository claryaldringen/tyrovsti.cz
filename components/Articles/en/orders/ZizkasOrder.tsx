...
export const ZizkasOrder = ({ draft }: ArticleProps) => (
  <>
    ...
    <Row>
      ...
      <Col md={6}>
        <p>
          By the grace and gift of the Father and Lord Almighty God, having
          believed and accepted the enlightenment of certain, steadfast,
          proclaimed, and justified truth and God&apos;s law:
        </p>
        <p>
          First, let us give freedom to God&apos;s word in preaching everywhere,
          without excluding any place, and accepting it dearly in our hearts,
          fulfill and hold it truly, then lead and teach others to do the same.
        </p>
        <p>
          Second, let us all receive the body and blood of our Lord Jesus
          Christ, God Almighty, with reverence, piety, and honor, old and young,
          children immediately after baptism, and then always children, without
          excluding any persons, urging and compelling them to it, at least
          every Sunday each week.
        </p>
        <p>
          Third, let us bring and lead the clergy to the life of the Son of God,
          Lord Jesus Christ, and to the apostolic life, and with God&apos;s help
          abolish and destroy their endowments and the goods of simony.
        </p>
        <p>
          Fourth, let us first abolish and destroy mortal and venial sins in
          ourselves, then among kings, princes, lords, townspeople, craftsmen,
          peasants, and all people, male and female, young and old, always with
          the help of Almighty God.
        </p>
        <p>
          And whoever does not want to hold, lead, and fulfill these points and
          articles written above, help, defend, and protect them, we do not wish
          to tolerate them in the field among us and in the camp with God&apos;s
          help and in castles, fortresses, towns, fortified and open small
          towns, in villages and farms, without excluding or excusing any place,
          but not excluding anyone, admonishing, advising, urging, and chasing
          them towards the good with the help of our Lord God.
        </p>
        <p>
          And therefore, moved by a good spirit, knowing and understanding that
          all the things of this world are fleeting and past, but the truth of
          the Lord Jesus Christ, God Almighty, remains forever:
        </p>
        <p>
          We, Jan brother Žižka of Kalich, Jan Roháč of Dubě, Aleš of Rysmburk
          and Vřešťov, Jan of Počtajna on Žampach, Boček of Kunstát and
          elsewhere of Jevišovice, Bartoš and Bernart, brothers of Valečov,
          Bartoš, Jan, Martin, brothers of Vysoká; and we, mayors and councilors
          and all the communities of the towns of Hradec nad Labem and Čáslav;
          we, Beneš of Mokrovousy, Jaroslav of Kalich, Václav Horina of Honbice,
          Křišťan of Žernoseky, Frencl of Litožnice, Jíra of Řečice, Jan of
          Studená; and we, mayor and councilors and all the community of the
          town of Jaroměř; we, Zdislav Zeman, Vavřinec Polák of Paňov, Blažek of
          Kralupy, Jakub of Březová, Petřík Královec of Příbram, Jan of
          Domažlice, Jan of Tehov, Martin of Borovnice, Havel Orebský; and we,
          mayor and councilors and all the community of the town of Dvůr; and
          we, Chústník of Košov, Ondřej of Studená, Šárka of Slavný, Kříž
          Captain, Beneš Captain, Mikát Brada Odraný, Aleš of Hostačov, Polévka
          of Hošťka, Mikuláš Orebský, Veta of Chlumčan, Litobor of Trubče,
          Linhart of Slez, Beneš of Horošovice, Jan Baštín, Mařík Velek Šeňk,
          Jíra Roh, Mikuláš Brada, commanders, lords, knights, squires, mayors,
          councilors and all noble, knightly, squire, and municipal communities,
          without excluding or excusing any; we all, written above, to all and
          everyone, ask and admonish in order, and command, wanting proper
          obedience; because through disobedience and improper actions, we have
          often taken great harm to our brothers and property and often suffered
          shame from the enemies of God and ours. With God&apos;s help and yours
          and all the faithful, we mean to avoid this with these customs:
        </p>
        <p>
          First, when we want to depart from any town or move from the place
          where we have camped, no one should ride ahead to the town or go
          there, nor travel to reserve a place or inn, nor set up camp without
          the permission and order of the named elders, commanders who will be
          appointed and named for this purpose. And if anyone camps or moves
          without the order of these elders, we wish to avenge and punish him,
          and such, including his property and life, as disobedient, whoever he
          may be, of any order, without excluding anyone.
        </p>
        <p>
          And when they want to move from that place where they have camped,
          they should set out to the field with the permission and order of the
          named elders, to a suitable and worthy place, and wait there for the
          whole army to move from the position.
        </p>
        <p>
          And no one should set fires or burn anywhere else while we are moving
          or camped, except those who are appointed and established for this
          purpose, under a severe penalty, no one else should do this.
        </p>
        <p>
          Then, before they immediately depart from the town, before they do or
          command any things, they should first pray to the Lord God, kneeling
          and bowing before the body of God and before God&apos;s face, when
          departing from the camp or town, so that the Almighty Lord may give
          his help and carry out his holy cause to his holy glory and the
          increase of the good and salvation and help to the faithful.
        </p>
        <p>
          Then let them arrange and organize the people, each company under its
          banners, let the password be given, and then let them immediately set
          out and march, the company organized that day under its banners; and
          others should not mix with them, nor hinder them, nor break away.
          Wherever and however the companies or banners are organized, let them
          march in their formation and together, not mixing with each other, and
          this carefully, guarding the front, back, and sides of the army and
          themselves, as ordered by the elders.
        </p>
        <p>
          And if God does not protect them, and they suffer harm due to their
          negligence or the negligence of the commanders in the camp or on guard
          posts or in the field or in the watches, where ordered and entrusted
          by the elders and the communities, without excluding anyone, the
          commanders and all the communities mean to look into it and execute
          them, their property, and their lives, as disobedient, whoever they
          may be, of any order, without excluding or excusing anyone.
        </p>
        <p>
          But if God allows us to overcome and defeat the enemies, to capture
          towns, fortresses, castles, and to march through the field or camp,
          whatever spoils are taken, they should be gathered, collected,
          transported, and piled up where a place is indicated and named by the
          elders, whether much or little. For this purpose, elders shall be
          appointed from all communities, from the noble, knightly, and common
          people, to honestly distribute these things to the poor and the rich,
          and fairly, as befits each, so that no one takes for themselves or
          keeps anything. If anyone takes or keeps anything, and it is proven
          with good conscience, such a person should be executed for it, both
          their life and property, whoever they may be, without excluding
          anyone, as a thief against God and the community, as happened to Achan
          for the royal daughters&apos; cap and cloak, or by any other death,
          whether a noble, lord, knight, squire, townsman, craftsman, or
          peasant, without excluding or excusing anyone, with God&apos;s help,
          thus executing vengeance.
        </p>
        <p>
          Further, there should be no quarrels, cries, or brawls in the camp or
          among us.
        </p>
        <p>
          If anyone beats, injures, cripples, or kills someone, they shall be
          avenged according to God&apos;s law, as the Lord allows, without
          excluding or excusing anyone.
        </p>
        <p>
          Further know that whoever sneaks away, goes, rides, or drives away
          from us from the army, when we are marching or camped, without the
          permission of the aforementioned elders, and without a certain sign,
          whether a noble, lord, knight, squire, townsman, craftsman, or
          peasant, and is caught, they shall be executed, both their life and
          property, as a faithless thief who sneaks away from God&apos;s cause
          and faithful brothers from the army, wherever the army is or lies.
        </p>
        <p>
          Also, we do not wish to tolerate among us the unfaithful, disobedient,
          liars, thieves, gamblers, robbers, looters, drunkards, swindlers,
          adulterers, fornicators, and all open sinners and sinning women; we
          wish to drive and chase them away from us, executing them with the
          help of the Holy Trinity according to God&apos;s law.
        </p>
        <p>
          Brother Žižka and other lords, commanders, knights, squires, townsmen,
          craftsmen, and peasants written and named above, along with all
          communities with God&apos;s help and communal aid, intend to punish
          and beat all disorderly conduct, chasing, whipping, beating, killing,
          beheading, hanging, drowning, burning, and avenging with all
          appropriate punishments that befit the wicked according to God&apos;s
          law, without excluding any persons of all statuses, male and female.
        </p>
        <p>
          And if we keep, do, and fulfill the above-written and salvific
          articles, the Lord God will be with us with his holy grace and help,
          for it belongs to God&apos;s fight to act so, to live well,
          Christianly, organized in love, to live in the fear of God, to place
          our desires, needs, and hopes in the Lord God steadfastly without
          fail, waiting for eternal reward from him.
        </p>
        <p>
          We also ask you, dear communities, from all and all regions, princes,
          lords, knights, squires, townsmen, craftsmen, peasants, and people of
          all statuses, especially first all faithful Czechs, to agree to this
          good and be willing and helpful to us. And we will, in return, also
          want to hold, fulfill, and avenge for the dear Lord God, for his holy
          suffering, for the liberation of the truth of God&apos;s law, the
          saints and their glorification, to help the faithful to the holy
          church, especially to the Czech and Slavic languages, and all
          Christianity, to uplift the faithful and to humiliate the stubborn and
          open heretics and hypocrites and vile people, so that the Almighty
          Lord may grant us and you his help and victory over his and our
          enemies, and fight for us and with you with his power, not separating
          us from his holy grace. Amen.
        </p>
        <p>
          May the Lord God be with us and with you, wherever you are, and
          wherever it pleases the Holy Trinity! And for better conscience and
          confirmation and certainty with greater diligence according to the
          clergy above the miserable reason of this world, we, the undersigned,
          knowingly and with good will, agree to this record and letter, and
          agree to truly hold and keep it with the help of the uncreated and
          forever blessed Holy Trinity. Amen.
        </p>
        <p>So may the Lord God grant!</p>
      </Col>
    </Row>
  </>
)
