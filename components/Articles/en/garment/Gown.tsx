    ...
    <Row>
      <Col>
        ...
        <p>
          ...
          with narrow or wide sleeves. The term &ldquo;simple&rdquo; does not
  ...
  and draping on the altar panel from Jeníkov, around 1460."
    ...
    <Row>
      <ImageWithTitle
        ...
        width={499}
        height={548}
        title="An angel in a long simple gown with tapering sleeves and a stand-up collar on the fresco from the Mintmaster's Chapel, St. Barbara's Church, Kutná Hora (1460-1470)"
      />
      <ImageWithTitle
        md={4}
        src="andel2.jpg"
        width={325}
        height={381}
        title="An angel in a long, plain gown with tapered sleeves and a stand-up collar on a fresco from the Mintmaster's Chapel, St. Barbara's Church, Kutná Hora (1460-1470)."
      />
      <ImageWithTitle
        md={4}
    ...
    <Row>
      <ImageWithTitle
        ...
        width={974}
        height={1622}
        title="Meeting of the municipal council in the depiction from the Memorial Book of Olomouc (1430-1492). Scribe Václav from Jihlava (bottom left) wears a blue gown, lined with fur, with a square baggy sleeve and only one opening for the hand. The councilor in blue above him has a gown with a baggy sleeve, but with a free end, similarly to the man in green from the illumination in the Shortened Chronicles by David Aubert. It also shows how Czech gowns appear somewhat flattened compared to their Western counterparts."
      />
      <ImageWithTitle
        md={4}
        ...
        width={240}
        height={320}
        title="Václav of Jihlava in a purple gown lined with fur and baggy sleeves. Excerpt from the Brno Legal Book of Václav of Jihlava (1446)."
      />
    </Row>
    <Row>
      <ImageWithTitle
