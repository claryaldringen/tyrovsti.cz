...
export const Doublet = ({ draft }: ArticleProps) => (
  <>
    <Row>
      <Col>
        <div className="anchor" id="doublet" />
        <h4>Doublet{draft && <DraftBadge />}</h4>
      </Col>
    </Row>
    <Row>
      <Col>
        <p>
          ...
          term has been used since the 14th century to denote a shorter and
    ...
    <Row>
      <Col>
        <p>
          As previously mentioned, during King George of Poděbrady&apos;s era,
          the doublet was somewhat of an intermediate stage between undergarment
          and outerwear, not only in Bohemia. Therefore, the body of the doublet
    ...
    <Row>
      <Col>
        <p>
          The lack of Czech pictorial sources and the fact that during King
          George of Poděbrady&apos;s era the doublet was an intermediate layer
          between the undergarment and the outerwear greatly complicates
          research efforts. Nevertheless, some details and differences compared
          to other regions can be traced. The sleeves of Czech doublets are
          either narrow or wide, tightened with a short cuff at the wrist. In
          contrast, shoulder padding according to Burgundian fashion or
          gathering of the upper half of the sleeve as in Italian fashion is not
          found.
        </p>
      </Col>
    </Row>
    ...
    <Row>
      <Col>
        ...
        <p>
          The entire doublet is sewn completely by hand. The reconstruction was
