...
export const FencingManual = ({ draft }: ArticleProps) => (
  <>
    <Row>
      <Col>
        <h1>
          Fechtbuch by Joachim Meyer (MS Bibl. 2465){draft && <DraftBadge />}
        </h1>
        <p>
          <b>MS Bibl. 2465</b> is a German fencing manual written by Joachim
          Meyer in 1561. The original is currently held in the collections of
          the Bavarian National Museum in Munich, Germany. This manuscript,
          which may be Meyer&apos;s earliest work, was created for Georg Johann
          II, Count Palatine of Veldenz. Since the mid-20th century it was
          believed to be lost, but Olivier Dupuis announced in June 2021 that he
          had rediscovered it.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col md={6}>
        <h4>On foot combat and fighting in armour, briefly described</h4>
        <p>
          Since combat has many forms, no fixed rule can be given. Whoever is
          challenged to fight has the advantage that he may devise whatever he
          knows will serve him best &ndash; whether unusual weapons or cunning
          and skilful advantages. For the one who is challenged determines the
          weapons and may choose them as he wishes.
          <br />
          For example: Two men are to fight each other, and one is left-handed
          and the other right-handed. The right-hander challenges the
          left-hander. The left-hander therefore chooses the weapons as follows:
          two sharp rapiers and two sharp daggers. Furthermore, two vambraces
          (armschirleinn), one for each man on the right arm, since the
          left-hander&apos;s right hand is less dexterous, and inside each
          vambrace at the bend is a sharp point, so that when someone bends that
          arm even slightly, it stabs him.
          <br />
          When they arrive at the appointed place and are given their weapons,
          each puts on his vambrace on his right arm as directed. Once they are
          to enter combat, the right-hander cannot defend himself &ndash; as
          soon as he bends his arm, he stabs himself.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col md={6}>
        <p>
          Moreover, his left arm is bare, in which he holds the dagger for
          defence. The left-hander, however, holds his right arm steady with the
          dagger for parrying and fights with his left hand. Thus the
          right-hander suffers more harm from himself than from the opponent.
          <br />
          From this example it is easy to see that whoever chooses or provides
          the weapons always has the greatest advantage. I have told this so
          that anyone who wishes to challenge another to combat should be
          mindful of such tricks and not act rashly in anger, but rather offer
          the challenge with calm deliberation &ndash; just as it has also been
          the custom that two men agree whether they will fight in full armour,
          or without it, or with weapons of their own choosing.
          <br />
          As for fighting or combat without armour and what advantages there are
          and how to use them, this has been sufficiently taught in the rapier
          and other weapons and is well understood. I now wish only to describe
          the advantages in armoured fighting, how to use and apply them. And it
          should be noted that three weapons are commonly used in armoured
          combat: a spear and a sword, also a dagger &ndash; or a dagger and a
          sabre girded at the waist, and a sword.
          <br />
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col md={6}>
        <p>
          The first arrangement of weapons for armoured combat is this: a spear
          and a sword and a fighting dagger or a dagger, or also a shield. In
          the attack one used the shield and the spear and worked with the spear
          &ndash; for example, whether one could trip the other between the legs
          and evade, or whether one threw the spear and then followed up, since
          in earlier times throwing the spear was greatly practised. After they
          had thrown their spears, they reached for the sword and further for
          the dagger or fighting dagger.
          <br />
          I, however, wish to take up another arrangement in order to show how
          foot combat is conducted, and I also wish to name three advantageous,
          cunningly made weapons. The first of these is a sword, which should be
          as follows: the pommel should have four points around the sides and a
          fifth on top, which should not be long but rather compact so that it
          can withstand blows. The cross-guard should be shaped like a
          mason&apos;s hammer, and the point and blade should be angular. And
          all of this should be forged from a single piece of iron with the
          point well tempered.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col md={6}>
        <p>
          The sword should also be made supple enough that a man can wield it
          freely, and its length should suit each man.
          <br />
          The sabre should be strong, with a good edge, but not too heavy.
          <br />
          The dagger should be triple, with three blades nested inside one
          another &ndash; as if one stuck three skewers into each other. The
          edges of these three blades should close upon one another and be
          fitted with springs, so that when one part is pressed, a blade is
          released. This is used when one strikes into a joint gap &ndash; then
          the blade tears the gap open and creates a wide hole. <br />
          When the first part of the dagger is then released, the second point
          is smaller and slimmer and can penetrate into the hole that was made,
          which goes deeper than the first. When one feels that the blade has
          entered the body, one releases the spring and lets the stronger point
          extend, which the opponent cannot easily pull out.
          <br />
          The dagger is used once the opponent has been brought down. If the
          weapon gets stuck, the dagger can easily be freed and used again. But
          it must be made so that the springs are not visible, so that when
          looking at the weapon they are not apparent and the opponent can
          hardly recognise them.
          <br />
          Whoever uses this weapon should practise with it thoroughly beforehand
          and seek his advantage in it, since the opponent will not quickly
          recognise or use it in the heat of combat.
          <br />
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          Take care that he does not surprise you with a thunderous blow, and
          let him strike first in vain. Remember, when he delivers a blow, you
          should catch it between both your hands &ndash; and see whether you
          can strike him.
          <br />
          Furthermore, take care that you are not caught off guard by a thrust.
          If, however, a thrust has been set against your left side, step back
          with your left foot or place the pommel of your sword upon your chest
          and direct the point towards the opponent. Then set it against him as
          well and push him away from you.
          <br />
          And when he swings widely around himself, follow with the point toward
          his openings. Remember, the openings are these: the visor, under the
          armpits, the knuckles, the hands, between the legs, from outside into
          the gauntlet, and wherever the armour has joints. Remember not to
          reach for a more distant opening when you can strike a nearer one. And
          lastly: release his fingers, namely wherever someone grips you, see
          whether you can seize one finger and break the hold.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          Free yourself and, if possible, break his stance. Also strike him in
          the groin, break his leg or deliver a knee thrust.
          <br />
          First I wish to go through armoured fighting by way of examples, and
          then describe the advantages of the aforementioned weapons.
          <br />
          Upon entering combat, take your sword into the upper guard (Oberhut),
          both hands beside your head, and grip the blade in the middle with
          your left hand so that the point faces the opponent&apos;s face.
          Advance toward him in this manner so that your left foot is always
          forward &ndash; not too far. And see whether you can reach his leading
          foot. Then feint as if you would strike his face, release your right
          hand from the hilt and bring it to assist your left hand, and strike
          him with the pommel on his head or on his left arm. If he catches your
          blow between both his hands, let the sword swing around the head and
          strike him from your right side on his knee or ankle.
          <br />
          Furthermore, approach him in the upper guard (Oberhut) as before and
          watch whether he intends to thrust or strike &ndash; then deflect it
          with your left hand. If he then strikes from above, catch his blow
          between both your hands and meanwhile thrust from outside over his arm
          at his throat.
          <br />
        </p>
      </Col>
    ...
    <Row>
      ...
      <Col>
        <p>
          When your point holds firm, strike with both hands under your right
          armpit and do not let him withdraw; instead, press forward. Also from
          the upper guard, approach him and thrust at his visor. If he wards it
          off, set the point against his left shoulder and press forward. Take
          care that as soon as he tries to free himself, you press your weight
          upon him with wrestling, throwing, or pushing &ndash; directly into
          his visor. Remember: once you have set your point against someone, do
          not let him escape, for then he cannot work.
          <br />
          The second guard: hold your sword with the hilt beside your right hip
          and grip the blade in the middle with your left hand so that the point
          faces the opponent. The left foot always forward. Advance toward him
          thus: if he thrusts, deflect it with your hand; if he strikes, catch
          the blow between both your hands in the blade. Meanwhile watch when he
          strikes and step with your right foot toward you, parry as you were
          taught, and drive the pommel into the back of his knee.
          <br />
          If he tries to withdraw that foot, set the point under his right
          armpit or wherever you can, and push him away from you. Or bring the
          pommel around his neck, step with your right foot behind his leg, and
          throw him down. Also catch his blow from the guard and drive upward
    ...
    <Row>
      ...
      <Col>
        <p>
          joints. Also deflect his thrust, and do likewise. As often as you have
          set against him, strike your pommel under his armpits whenever you see
          your advantage. There are four points to set against: one in the face,
          one at the throat, one at the left armpit, or one under the right
          shoulder.
          <br />
          Remember: when you set against his left side, advance with the left
          foot forward; when you set under his right shoulder, step forward with
          the right foot. Furthermore, whenever you have set against him you
          should always press upward. But if he is shorter than you, lower your
          hilt down to hip level and then press upward away from you. If he
          leaves his side open, thrust at his helmet, for that is where he is
          weakest.
          <br />
          Whenever you set against him, make sure you set the point well into
          the mail, for when you set correctly and press correctly, he cannot
          work effectively. <br />
          Counter: if someone has set against you, thrust from above over his
          right arm, going in under his sword, and press your pommel downward
          toward the ground. As soon as he releases, shoot your sword forward
          under his right arm and with your right foot step behind his left, and
          with your left hand seize his helmet and throw him quickly backward.
          <br />
          Also thrust into the gauntlet of his leading hand and lead him around,
          or thrust under his left arm upward over his sword, press with the
          pommel upward, and set against him. Also, regarding
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          wrestling, note from which side he has set against you, then grip his
          blade with your left hand and push it away from you; meanwhile pull
          back and draw him toward you. Seize his right hand with your right
          hand, pull him toward you, grasp his body, and lift upward. When you
          lift him, strike his feet out from under him and throw him away from
          you.
          <br />
          Furthermore, if someone thrusts at you, thrust simultaneously inward
          at his left side, and in the thrust catch his blade against yours and
          drive your pommel from below through both arms and strike upward, so
          that he must let go.
          <br />
          Also take care: whichever hand you can seize, pull it toward you, and
          with the other hand grip his elbow and take his balance. In all these
          steps, do not step too high, so that you maintain a firm stance.
          <br />
          Furthermore, if you have thrown someone and he falls, fall with him to
          his right side with your right knee between both his legs and your
          left hand around his neck. Once you hold him securely, draw your
          dagger. If he reaches for the dagger, stab him in the hand and pull it
          back until you see a better advantage.
          <br />
          Another way: take his right arm between his legs, lay yourself across
          him, and hold your legs tightly together.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          and stretch yourself firmly, and with your left hand seize his left
          arm and hold it fast, and work with the dagger as will follow
          hereafter.
        </p>
        <h4>How the three aforementioned weapons should be used</h4>
        <p>
          Remember: at the first approach, advance toward him in the upper guard
          and position yourself with the gesture as if you would strike his
          face, but do not &ndash; instead, strike or cut downward from above at
          his kneecap. Whether you hit or not, continue nimbly upward with your
          hands and strike him with the beak of the cross-guard on the head,
          from outside over his right arm, or strike him on the nearest joint
          you can reach.
          <br />
          Pull swiftly around your head and let your right hand slide in front
          of the left, and with it grip the blade behind your left hand and
          deliver a middle strike (Mittelschlag) from your right at his helmet
          &ndash; whether with the beak, the edge, or the pommel.
          <br />
          He seizes your bind; with your right hand once more step back to
          regain your balance and take great care that he does not land a blow.
          Also do not try to set against him, but rather yield in a circle as
          much as possible.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <h4>The second technique</h4>
        <p>
          Remember: step toward him in the upper guard, grip your hold near the
          pommel and with the left hand grip the blade at the cross-guard, and
          thrust forcefully (knefftiglich) at his visor. Pull back toward
          yourself and thrust strongly from below at his groin so that he does
          not dare come too close.
          <br />
          Then draw your weapon back and with the left hand grip the first third
          of your blade. If he presses upon you, step back &ndash; this will
          draw him into overcommitting and he will soon strike. Do not let him
          reach you, but dodge aside. If he has struck and misses, release your
          right hand and bring it to assist the left, and strike him on the
          helmet or on the nearest limb.
          <br />
          If, however, he has not struck, then strike him on the knee or ankle.
          If he parries, drive upward with both arms, strike him on the upper
          joint, and seize your grip again with both hands.
          <br />
          But if you truly cannot avoid the blow, catch it above between both
          hands in the blade and meanwhile throw the pommel over your left
          shoulder, and drive upward with the left hand and bring the right to
          assist the left. Thus you will land a blow before he recovers his
          stance.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          Remember: when he approaches you in the upper guard and thrusts or
          strikes, deflect it with your left hand. In the deflection, seize his
          blade against yours and guide it with the bind from below through, and
          step with your right foot behind his left and throw him.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          Furthermore, if he strikes from below, lower the pommel downward
          toward the ground and catch it between both your hands. As he raises
          his sword again, drive your pommel from below upward at his genitals
          and meanwhile turn your left hand upward against his incoming strike
          and deflect it, and then drive upward with the hilt and thrust over
          his right arm into his face and set against him.
          <br />
          Also approach the man in the lower guard (Unterhut) and thrust from
          below at his face. If he strikes or thrusts from below, deflect it and
          release the right hand from the grip and throw it behind you. Bring
          your right hand to assist the left and strike from below upward with
          the beak between his legs at the groin. Immediately pull both hands
          upward around the head and strike at the upper openings.
          <br />
          Also approach him in the lower guard, feint and threaten him with a
          thrust. Meanwhile release your grip, step around his left side, grip
          your blade with both hands, and throw the beak of the cross-guard into
          his hip under his breastplate with force into the mail.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          Also thrust at him from the lower guard at the groin, pull back, and
          release your grip from the right hand and with it grip the blade. If
          he strikes, take it with your hilt from your right against his left.
          In taking it, let your hilt swing around the head and strike him in
          the back of his leading knee. Quickly take one step backward so that
          you maintain your balance and seize your grip again.
          <br />
          From the techniques described thus far, it is sufficiently clear how
          one should deliver the blows. And it should be noted that one should
          guard against setting or wrestling as much as possible until one has
          first greatly weakened the opponent with thunderous blows to the
          ankle, the knee, the joints at the elbow, and other openings. When he
          is thus exhausted and weakened by blows, then proceed with setting
          against him.
          <br />
          Before that, you should not stand your ground against him, but
          constantly yield at a measured pace and let him exhaust himself; yet
          whenever you see an advantage, do not let it pass fruitlessly.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          Now approach him and set against him with a firm stance from the upper
          guard, and thrust with force into his visor. If he defends upward and
          tries to deflect, pull aside and thrust him under his left arm. Take
          care that you stand firmly and do not overbalance your weight.
          Remember, as soon as your point holds fast in the grapple, strike your
          hilt under your right armpit and press him forward, or set against him
          under his right armpit and strike the pommel under your left armpit,
          and press him away from you and do not let him escape. Then draw the
          sabre with your right hand and work at his joints, or with undercuts.
          <br />
          Also feint as if you would strike him with the pommel in the visor. As
          soon as you notice that he starts to parry between both hands, pull
          back swiftly and set against him under the right armpit. And remember:
          when you thus seize him by setting under the right armpit and also
          with your arm under your left armpit as previously taught &ndash; with
          what cunning this is done &ndash; then he cannot draw his sabre. And
          that is also the advantage of the sabre.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          And when he strikes at your knee, parry with the middle of your blade
          behind his cross-guard, seize his sword against yours, and drive the
          pommel into the back of his knee. Pull him toward you and push him
          away with your left hand.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          ...
          schwerdt zu dem deinen / las die Recht hanndt Ab vnnd greiff sein
      ...
      <Col>
        <p>
          Also thrust simultaneously with him inward from your right against his
          left, with your point well over his sword. Seize his sword against
          yours, release the right hand, and grip his left elbow. Pull it upward
          toward you on your left side and advance with your left foot &ndash;
          so he falls.
          <br />
          Furthermore, upon approaching, position yourself with the gesture as
          if you would thrust at him, but pull back toward yourself and let your
          grip slide over your left arm, and deliver a bind-strike (Bundtschlag)
          or cut at his right shoulder. Note: as soon as he starts to parry,
          complete the strike with the left hand and meanwhile reach with the
          right hand from below through your sword and seize his right hand.
          Pull him toward you and bring the left hand together with the sword to
          assist the right &ndash; break him or throw him as you see fit.
          <br />
          Also strike him with the grip at his head. During the strike, release
          your hand and with that same hand seize his right elbow. Then advance
          with the left foot and push him away from you.
        </p>
      </Col>
    </Row>
    <Row>
    ...
    <Row>
      ...
      <Col>
        <p>
          ...
          vnnd Im zur vorsazung zucke Inndes daß schwerdt obenn vm / vnnd stich
      ...
      <Col>
        <p>
          Furthermore, when you have weakened him with thunderous blows as
          previously taught, grasp your sword as before in the upper guard and
          thrust at him from above. During the thrust, release the right hand
          from the grip and draw the sabre. As soon as he also draws his, cut at
          his hand and quickly follow up with the sabre from below upward at his
          arm. Step with your right foot behind his left and strike with the
          pommel at his throat, at his shoulder, or at his face &ndash; so he
          falls.
          <br />
          Furthermore, once you have drawn both weapons, advance toward him with
          the right foot forward. Hold the sabre in the right hand and the sword
          in the left hand for thrusting. Advance and thrust from above into his
          face, and drive the sabre from below upward between you and him for a
          parry. Meanwhile let the sword swing from above and thrust at his
          groin. If he reaches with his left hand for the sword, release it and
          with your left hand seize his left hand, pull it toward you, and
          strike with the sabre at his joint. Step with your right foot in front
          of his left, turn to your left side, and throw him over your right leg
          &ndash; or break his arm.
          <br />
    ...
    <Row>
      ...
      <Col>
        <p>
          reaches for his sabre or for your sword, seize his right hand with
          your left, pull it toward you, twist it downward, and strike with the
          sabre at his joint at the elbow and break his arm.
          <br />
          Furthermore, if you have been separated from your sword, go at him
          with your sabre and with your left hand seize the blade of his sword.
          Trap it under your left armpit, or hold it firmly away from you, and
          cut at his hand. If he releases the sword and reaches for the sabre,
          thrust with the sabre from outside into his gauntlet. Do not pull back
          but strike with the hilt into his face and trip him backward &ndash;
          so he falls.
          <br />
          Furthermore, if you have seized his sword and he wants to draw his
          sabre, cut at his hand or release his sword and seize his right hand.
          Pull it toward you and thrust or strike him with the pommel of the
          sabre at his joint.
          <br />
          In summary: with the sword you should cut through his armour joints;
          with the beak or edge, strike the kneecaps and gaps; and with the
          pommel, weaken, break, and hammer the joints and limbs, and also set
          against him. But if your
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          sword has been taken or you have been separated from it, you should
          work with the sabre and close in with wrestling, and strike with the
          pommel under his eyes, and see whether you can hook or trip his leg.
          <br />
          Furthermore, if you have lost your sword and the opponent has drawn
          both weapons, hold yourself in the lower guard and wait with the right
          hand to see whether you can seize his sword, and with the sabre wait
          for his strike. See whether you can gain the advantage against his
          left elbow. You should not draw the dagger until you have thrown him.
          <br />
          When you have thrown him, catch his right arm with your left knee and
          place your left hand at his throat. Grip his left hand with your right
          and bring your left hand to assist the right. Then draw your dagger
          and work between the joints where you think it most harmful. When you
          have opened the joints, press a spring to release and thrust with the
          smaller blade between
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          the opened joints. Furthermore, release the dagger entirely with all
          its points and work with the smaller blade at the helmet where it is
          open. Where other openings are to be found has been taught before.
          <br />
          If he falls on his belly, fall upon the joints of his arm with your
          knee and break his arms. Also fall upon the buckles of the armour on
          his back.
          <br />
          When you have thrown him, stab into the ground and fill his visor, or
          cut something from his coat of arms and block his visor. Then work
          with the dagger at the groin, or between the joints, or thrust at his
          heart, or at the joints wherever they are.
          <br />
          Lastly it should be noted that, since it has come to pass that
          sometimes the same techniques appear in various weapons, I have for
          brevity&apos;s sake, where something was set down in one weapon, left
          it out in another, so long as this could be done without harm to
          understanding &ndash; so that I would not needlessly repeat the same
          thing. Also, since the art of fencing is such that one experienced in
          it should see his advantage even in unfamiliar weapons, I have
          arranged it so that one weapon is connected with another, so that
          whoever
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          wishes to practise and harmonise one weapon with another &ndash; so
          that what one has learned in the sword, one also tries in the dussack;
          and what one has learned in the dussack, one also carries over to the
          rapier, and from the rapier back to the dussack. Likewise, the
          wrestling and grips with the dagger into armoured fighting. Thus it
          also holds for longer weapons such as staves, halberds, and spears.
          Whoever follows this rule will find this book useful, and my diligence
          will be well rewarded. As it is made more for instruction than for
          mere display.
        </p>
      </Col>
    </Row>
