...
export const Fechtbuch = ({ draft }: ArticleProps) => (
  <>
    ...
    <Row>
      ...
      <Col md={6}>
        ...
        <p>
          ...
          disen fort¬ theill / das Er Im mag Erdencken was Er weis das Im
      ...
      <Col md={6}>
        ...
        <p>
          ...
          nejlépe poslouží – ať už neobvyklé zbraně nebo lstivá a obratná
          výhoda. Neboť ten, kdo je k boji vyzván, určuje zbraně a může si je
          zvolit, jak chce.
          <br />
          ...
          <br />
          Když tedy přijdou na místo boje a mají nasadit zbroj, každý si nasadí
          svou nátepní zbroj na pravou paži, jak je určeno. Jakmile mají
          vstoupit do boje, pravák se nemůže ubránit – jakmile jen trochu ohne
          paži, sám sebe bodne.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col md={6}>
        <p>
          ...
          aby si každý, kdo chce někomu nabídnout boj, dobře promyslel takové
          léčky a nejednal unáhleně ve vzteku, nýbrž aby se k tomu odhodlal s
          rozvahou a klidem – tak, jak se to také obvykle praktikovalo, že se
          dva dohodnou, zda budou bojovat v plné zbroji, nebo bez ní, nebo se
          zbraněmi, které si sami zvolí.
          <br />
          Co se týče samotného boje beze zbroje a různých výhod a způsobů jejich
          využití, to bylo dosud dostatečně vysvětleno při rapíru a jiných
          zbraních a je jasně pochopeno. Teď chci pouze popsat výhody v boji v
          plné zbroji, jak je využít a jak je postavit. A je třeba poznamenat,
          že se obvykle používají tři zbraně při boji v brnění: kopí a meč, také
          dýka – nebo dýka a šavle u pasu a meč.
          <br />
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col md={6}>
        <p>
          První uspořádání zbraní pro boj v plné zbroji je toto: kopí a meč a
          bojový tesák nebo dýka, případně také štít. Při útoku se používá štít
          a kopí a pracuje se s kopím – například jestli se jednomu podaří
          druhého srazit mezi nohy nebo se mu vyhnout, nebo jestli se s kopím
          hází a pak následuje kryt, protože v dřívějších časech bylo velkým
          uměním házet kopí. Poté, co kopí odhodili, sáhli po meči a dále po
          dýce nebo bojovém tesáku.
          <br />
          Já však chci pro sebe vzít jiné uspořádání, abych ukázal, jak se má
          bojovat pěšky, a chci také jmenovat tři výhodné, uměle vyrobené
          zbraně. První z nich je meč, který má mít nahoře hlavici se čtyřmi
          hroty po stranách a pátým nahoře, který nemá být dlouhý, ale spíše
          kompaktní, aby vydržel nárazy. Záštita má být jako zednické kladivo,
          špička a čepel mají být hranaté. A to vše má být vykováno z jednoho
          kusu železa a hrot dobře zakalený.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col md={6}>
        <p>
          Meč má být také pěkně ohebný, aby ho člověk mohl dobře ovládat, a
          délka i provedení mají každému vyhovovat.
          <br />
          Šavle má být pevná, s dobrou čepelí, ale nemá být příliš těžká.
          <br />
          Dýka má být trojitá, se třemi čepelemi zasazenými do sebe – jako kdyby
          člověk zasunul tři špejle do sebe. Hrany těchto tří čepelí se mají
          uzavírat na sebe a být spojeny pružinami tak, aby když se jedna část
          stiskne, jedna z čepelí se vysune. To se používá tehdy, když člověk
          zasáhne spáru – pak čepel roztrhne spáru a vytvoří velký otvor. <br />
          Když pak uvolní první část dýky, druhý hrot je menší a štíhlejší a
          může proniknout do vzniklého otvoru, který jde hlouběji než první.
    ...
    <Row>
      ...
      <Col>
        <p>
          ...
          přilož hlavici meče na svou hruď a umísti hrot proti soupeři. Potom mu
          ho také nasaď a tlač ho od sebe.
          <br />A když on kolem sebe prudce seká, pohybuj hrotem meče proti jeho
          odkrytým místům. Pamatuj, že odkrytá místa jsou tato: hledí, pod
          podpažím, kolena, ruce, mezi nohama, zvenčí do rukavice a tam, kde má
          zbroj klouby. Pamatuj, abys neútočil po vzdálenějších odkrytích, když
          můžeš zasáhnout blíž. A nakonec: uvolni jeho prsty, totiž tam, kde tě
          někdo uchopí, tak se dívej, zda mu můžeš vzít jeden prst a sevření
          rozlomit
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          ...
          zmíněných zbraní.
          <br />
          Při vstupu do boje vezmi svůj meč do horního střehu (Oberhut) , obě
          ruce vedle hlavy, a levou rukou uchop čepel uprostřed tak, aby hrot
          mířil protivníkovi do obličeje. Takto postupuj k němu, aby tvá levá
          noha byla vždy vepředu – ne příliš daleko. A dívej se, zda můžeš
          dosáhnout na jeho přední nohu. Tak se tvař, jako bys chtěl zasáhnout
          jeho obličej, pak uvolni pravou ruku z jílce a přidej ji levé ruce ku
          pomoci a udeř ho hlavicí meče do hlavy nebo do jeho levé paže. Pokud
          zachytí tvůj úder mezi svýma rukama, nech (meč) projet kolem hlavy a
          udeř ho z tvé pravé strany na jeho koleno nebo kotník.
          <br />
          Dále jdi k němu v horním střehu (Oberhut) jako předtím a dávej pozor,
          zda chce zasadit úder nebo bodnout – pak mu jej odtlač levou rukou.
          Pokud pak udeří shora, zachyť jeho úder mezi oběma rukama a přitom
          bodni zvenčí přes jeho paži na jeho hrdlo.
          <br />
        </p>
      </Col>
    </Row>
    ...
    <Row>
      ...
      <Col>
        <p>
          ...
          / hast Anngesezt so las Inn nit ab kumen / so khann Er nit Ar¬ beitten
          / Die ander hutt halt dein schwertt mit dem gefes neben deiner rechten
          hüfft / fast die klingen mit der Lincken hanndt Inn der mit / das dein
          ortt gegen dem mann stehe / denn Linck fus alzeitt vor / thritt also
          zu Im sticht Er so sez ab von der handt / schlecht Er so entpfang den
          streich zwischen dein beidt hendt Inn die klingen Inndes hab acht wenn
          Er schlecht / vnnd thritt mit dem Rechtenn zu dür / so versez wie
          gelertt / vnnd far mit dem knopf Inn sein kniebüg / will Er denn fus
          zucken so sez Im ann vnder sein Rehte vhsenn oder wo du khannst / vnnd
          thring von dür <br /> oder far mit dem knopff auff vmb sein hals vnndt
          thritt mit dem Rehten hinder sein bein vnnd würff Inn <br /> Ittem
          v[er]sez Im sein schlag aus der hutt vnd far auff mit dem gehilz /
          vnnd stich Im zum thrisell oder zu denn blößen bej den
        </p>
      </Col>
      <Col>
        <p>
          Když tvůj hrot drží pevně, udeř oběma rukama pod svou pravou paži a
          nenech ho odtáhnout, ale tlač proti němu. Také z horního střehu jdi k
          němu a bodni ho do hledí. Pokud ti to kryje, tak mu přilož (hrot) na
          jeho levé podpaží a tlač proti němu. Dávej pozor, jakmile se bude
          chtít vyprostit, abys na něj ihned zatlačil svou vahou - zápasem,
          hozením nebo strčením přímo do jeho hledí. Pamatuj: když někomu
          nasadíš (Anngesezt), nenech ho z toho uniknout, pak nebude moci dále
          pracovat.
          <br />
          Další střehové postavení: drž svůj meč s jílcem vedle své pravé kyčle
          a levou rukou uchop čepel uprostřed, aby hrot směřoval proti
          protivníkovi. Levá noha vždy vpředu. Přistup k němu tak, aby když
          bodá, odrazil jsi to rukou, a když seká, zachyť jeho úder mezi své
          ruce do čepele. Zároveň dávej pozor, když sekne a udělá krok pravou
          nohou, odraž to tak jak ses naučil a zasáhni ho hlavicí meče do jeho
          kolenního kloubu (jamky).
          <br />
          Pokud chce tou nohou couvnout, tak mu to nasaď na stehno nebo tam kam
          můžeš a tlač proti němu. Nebo jdi hlavicí meče kolem jeho krku, ukroč
          pravou nohou za něj a převrať ho na zem. Také zachyť jeho úder z
          horního střehu a bodni ho se zvednutým jílcem do hrdla nebo do
          odkrytých míst u
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          ...
          dem rechten vor / weitter soltu alweg so du anngesezt hast übersich
          thrinngen / so Er Aber kurczer ist dann du / so senck dein gehils
          vnndersich bis zu der hüfft / vnnd thring Also übersich von dür / last
          Er dür die seitten so stos Inn ann die hauben / do ist Er am
      ...
      <Col>
        <p>
          kloubů. Také odraž jeho bodnutí a udeř hlavicí svého meče pod jeho
          podpaží tak často jakmile v tom vidíš svou výhodu. Cíle pro zasazení
          úderu (Annsezenn) jsou čtyři: jeden do obličeje, druhý do hrdla, třetí
          do levého podpaží a čtvrtý pod pravé rameno.
          <br />
          ...
          nemůže dobře pracovat. <br />
          Protiakce: Když tě však takto zaváže on tak bodni shora přes jeho
          pravou paži pod jeho meč skrz, zatlač svou hlavici dolů k zemi a
          jakmile (soupeř) povolí, protlač svůj meč vpřed pod jeho pravicí skrz
          a se svou pravou nohou za jeho levý bok a uchop levou rukou za jeho
          přilbu a hoď ho rychle za sebe.
          <br />
          Také jej bodni do rukavice na jeho předsazené ruce a veď ho dokola
          nebo ho bodni pod jeho levou paži nahoru přes jeho meč, tlač hlavicí
          přes něj a zavaž ho. Také si
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          při zápasu všímej, ze které strany tě zavázal, pak uchop jeho čepel
          svou levou rukou, tlač takto od sebe a současně trhni pryč (zuzcken
          ab) a stáhni ho k sobě, chyť pravou rukou jeho pravou ruku a přitáhni
          si ho a uchop ho kolem těla a zvedni přes něj. Když ho zvedneš, udeř
          mu do nohou zespodu a hoď ho od sebe.
          <br />
          Dále, když někdo bodá proti tobě, bodni s ním současně dovnitř na jeho
          levou stranu a při bodu chyť jeho čepel ke své a veď svou hlavici
          zdola skrz obě paže a udeř přes něj, takže musí pustit.
          <br />
          Také: dávej pozor, kterou ruku mu můžeš zachytit, tu přitáhni k sobě,
          druhou ho chyť za loket a vezmi mu rovnováhu a ve všech těchto krocích
          nestoupej příliš vysoko abys měl pevný postoj.
          <br />
          Dále: pokud jsi někoho srazil, padne-li, pak padni spolu ním na jeho
          pravou stranu, s pravým kolenem mezi jeho nohama a s levou rukou kolem
          jeho krku. Když ho pevně držíš tak vytáhni dýku. Pokud po téí dýce
          sahá, bodni ho do ruky a stáhni ji zpět, dokud nevidíš lepší výhodu.
          <br />
          Další způsob: uchop jeho pravou paži mezi jeho nohama, polož se na něj
          napříč a drž své nohy pevně sevřené
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          a napni se pevně a uchop jeho levou paži svou levou rukou a drž ji
          pevně a pracuj s dýkou, jak bude dále popsáno.
        </p>
        <h4>Jak se mají používat ty tři dříve zmíněné zbraně</h4>
        <p>
          Pamatuj: při prvním útoku jdi k němu v horním střehu a nastav se s
          gestem jako bys mu chtěl zaútočit na obličej, ale nečiň to, místo toho
          ho udeř nebo sekej shora dolů na jeho kolenní kloub. Ať už zasháhneš
          nebo ne, tak pokračuj hbitě rukama přes něj a udeř ho záštitou do
          hlavy, zvenčí přes jeho pravou paži, nebo ho udeř na nejbližšé kloub,
          který se naskytne.
          <br />
          Trhni prudce kolem své hlavy a nech pravou (ruku) sklouznout před tu
          levou ruku, chyť za tvou levou (rukouú tu čepel a udeř z tvé pravé
          jeden střední úder (mittelschlag) na jeho helmu ať už záštitou, jílcem
          nebo hlavicí.
          <br />
          On uchopil tvou vazbu, opět s tvou pravou rukou a ustup opět zpátky
          abys znovu získal rovnováhu a dávej si velký pozor aby ti nemohl
          zasadti žádný úder. Také se nesnaž o útok (Annsezenn), nýbrž ustup v
          kruhu jak je to jen možné.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        ...
        <p>
          ...
          mit der Rechten der Lincken zu hilff so kum¬ mestu zu schlagen Ehe Er
          sich Erhalt
        </p>
      </Col>
      <Col>
        ...
        <p>
          ...
          <br />
          Poté stáhni zbraň zpět a levou rukou uchop první třetinu čepele. Když
          se na tebe tlačí, ustup dozadu – tím ho přivedeš do koncového tlaku a
          brzy na tebe udeří. Nedovol mu, aby tě zasáhl, ale uhni stranou pokud
          zaútočí a pak dávej pozor, kdy mine. Pak pusť pravou ruku a přijď s ní
          na pomoc levé ruce a udeř ho do přilby nebo na nejbližší končetinu.
          <br />
          Jestliže však neudeřil, tak ho udeř na koleno nebo kotník. Vykrije-li
          se, tak jdi rukama nahoru, udeř ho na horní kloub a uchop znovu oběma
          rukama.
          <br />
          Jestliže se však tomu úderu vážně nemůžeš vyhnout, tak jej vykryj
          nahoře do čepele mezi oběma rukama a současně hoď hlavici meče přes
          tvé levé rameno a zvedni levou ruku nahoru a přijď s pravou rukou na
          pomoc levé. Tak dosáhneš úderu dříve, než se vzpamatuje (znovu zaujme
          postoj).
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          Pamatuj: když proti tobě přistupuje z horního střehu a bodá nebo seká,
          odraž to levou rukou. A při tom odražení uchop jeho čepel ke své
          čepeli veď ji s vazbou (míněno držení soupeřovy čepele) spodem skrz a
          vykroč pravou (nohou) za jeho levou (nohu) a shoď ho.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          ...
          ge¬ sicht / schecht oder sticht Er vnndes / so sez ab / vnnd las die
          Recht hanndt vom binndt vnnd würff das hinder dich / khum mit der
          ...
          In¬ des las dein binndt fahrenn / vnnd thrit vm sein Linck greüff mit
          bej¬ denn hennden Inn dein khleing / vnnd würff Im denn bürkell Inn
          die hüfft vnder seim Burckenn geschmeidt mit sterck In die Ring
        </p>
      </Col>
      <Col>
        <p>
          Dále: A když seká zespodu, pak spusť hlavici pod sebe a zachyť (úder)
          mezi své ruce. Když znovu zdvihá svůj meč, tak veď svou hlavici zdola
          nahoru k jeho genitáliím a současně obrať levou ruku přes sebe proti
          jeho přicházejícímu seku a nastav proti němu kryt a poté vyjeď vzhůru
          s jílcem a bodni jej přes jeho pravou ruku do obličeje a zasaď mu
          ránu.
          <br />
          Dále jdi k pánovi ve spodním střehu (vnder hutt) a bodni jej zdola do
          obličeje. Když seká nebo bodá, odraž to a pusť pravou ruku z úchopu a
          hoď to za sebe. Přiveď pravou rukou na pomoc levé a udeř zdola vzhůru
          záštitou na spravedlivé místo (genitálie), ihned zatáhni oběma rukama
          přes sebe kolem hlavy a udeř na horní odkrytá místa.
          <br />
          Také přistup k němu v dolním střehu, cukni a lákej ho k bodnutí.
          Současně uvolni úchop, vykroič kolem jeho levé (nohy), uchop oběma
          rukama čepel svého meče a vhoď mu záštitu do kyčle pod jeho trup vržen
          silně do zápasu.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          ...
          dein binnd fachrenn aus der Rechten hanndt vnnd greüff domit Inn die
      ...
      <Col>
        <p>
          Také ho bodni ze spodního střehu do rozkroku, cukni zpět a pravou
          rukou pusť své sevření a uchop s ní čepel. Seká-li on, tak vezmi svůj
          jílec z tvé pravé (strany) na jeho levou (stranu) abys mu jej
          vyvedl/odebral (Im außnemen), nech svůj jílec projet kolem hlavy a
          udeř jej do kolene přední nohy, udělej jeden rychlý krok zpět a tím se
          udržíš (zachováš rovnováhu) a znovu uchopíš meč (na jílci).
          <br />
          Z těchto dosud popsaných kusů je dostatečně jasné, jakým způsobem má
          pán údery provádět a je třeba si povšimnout, že někdo se má mít na
          pozoru, jak jen může, před nasazením (páky) nebo zápasem dokud ho
          nejdříve silně neoslabil drtivými údery jako (např.) na kotník, na
          koleno, na klouby, na loket a jiná odkrytá místa. Když je tedy takto
          vyčerpán a oslaben údery, pak teprve přistup s nasazením (páky)
          <br />
          Nejdříve byses mu neměl postavit, ale stále klidně ustupovat a nechat
          ho vyčerpat se; nicméně, když uvidíš nějakou výhodu, ať není
          promarněna bez užitku.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          Dále přistup k němu a zasáhni ho pevným postavením z horního střehu a
          ...
          zpět a udeř ho pod jeho pravé podpaží. Pamatuj, že když někoho takto
          uchopíš a zasáhneš pod jeho pravé podpaží a zároveň svou rukou pod své
          levé podpaží, jak bylo dříve ukázáno – s jakou lstí to uděláš – pak on
          nemůže vytáhnout svou šavli. A to je také výhoda šavle.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          A když on seče směrem na koleno, odraž to svou čepelí za jeho záštitu,
          uchop jeho meč proti svému a udeř hlavicí do jeho kolenní jamky.
          Přitáhni ho k sobě a levou rukou ho odtlač pryč od sebe.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          Také bodni současně s ním směrem z tvé pravé strany proti jeho levé,
          přičemž tvůj hrot míří dobře nad jeho meč. Uchop jeho meč proti svému,
          uvolni pravou ruku a uchop jeho levý loket. Potom ho prudce přitáhni
          přes sebe na svou levou stranu a při tom přistup levou nohou – tak
          padne.
          <br />
          Dále, když k němu přistupuješ, dělej, jako bys mu chtěl zasáhnout
          přímo, ale pak rychle stáhni zbraň k sobě a nech svůj úchop projet
          přes tvou levou paži a udeř ho úderem nebo seknutím na jeho pravé
          rameno. Dávej pozor: jakmile on začne odrážet, dokonči úder levou
          rukou a mezitím pravou rukou přiveď svůj meč dolů a uchop jeho pravou
          ruku. Přitáhni ho k sobě a levou rukou spolu s mečem pravé ruky mu dej
          &bdquo;pomoc&ldquo; – zlom ho nebo ho shoď, podle potřeby.
          <br />
          Také ho udeř úchopem do hlavy a při tom úderu uvolni ruku a uchop tou
          samou rukou jeho pravý loket. Při tom přistup levou nohou a odtlač ho
          od sebe.
        </p>
      </Col>
    </Row>
    ...
    <Row>
      ...
      <Col>
        <p>
          ...
          so fas dein schwerdt wie nechst Inn die ober hutt vnnd stich Im oben
      ...
      <Col>
        <p>
          Dále, když ho oslabíš silnými údery, jak bylo dříve popsáno, uchop
          svůj meč v horním střehu a bodni mu shora. Při bodnutí uvolni pravou
          ruku z úchopu a vytáhni šavli. Jakmile on také tasí, sekej mu na ruku
          a okamžitě pokračuj šavlí zespoda vzhůru na jeho paži. Přistup pravou
          nohou za jeho levou a udeř hlavicí do jeho krku, do podpaží nebo do
          obličeje – tak padne.
          <br />
          Dále, když už jsi vytáhl obě zbraně, přistup k němu pravou nohou
          vpřed. Šavli drž v pravé ruce a meč v levé ruce k bodnutí. Přistup a
          bodni ho shora do obličeje a udeř šavlí zespoda vzhůru mezi sebe a
          jeho paži, aby ses připravil k dalšímu kroku. Přitom nech meč projet
          shora a bodni ho do slabin. Když on levou rukou sahá po tvém meči,
          uvolni úchop a levou rukou uchop jeho levou ruku, strhni ji k sobě a
          udeř šavlí do jeho kloubu. Přistup pravou nohou za jeho levou, otoč se
          na svou levou stranu a shoď ho přes svou pravou nohu – nebo mu zlom
          paži.
          <br />
    ...
    <Row>
      ...
      <Col>
        <p>
          když sahá po své šavli nebo po tvém meči, uchop jeho pravou ruku svou
          levou, přitáhni ji k sobě, otoč ji dolů a udeř šavlí do jeho kloubu na
          lokti a zlom mu paži.
          <br />
          Dále, když se dostaneš pryč od svého meče, jdi k němu se šavlí a levou
          rukou uchop jeho čepel, která je pod tvým levým podpažím, nebo ji
          pevně drž od sebe a udeř mu na ruku. Když pustí meč a sáhne po šavli,
          bodni ho šavlí zvenčí do rukavice. Nenechávej to být – udeř hlavicí
          šavle do jeho obličeje a okamžitě ustup vzad, tak padne.
          <br />
          Dále, když jsi mu uchopil jeho meč a on chce tasit šavli, sekej mu na
    ...
    <Row>
      ...
      <Col>
        <p>
          ...
          arbeitten vnnd mit Ringenn zu Im nachenn vnnd mit dem knopff vn¬ der /
          die augen steßenn / vnnd schawe das du Im Ein bein megest beschlißenn
          oder für threttenn <br />
      ...
      <Col>
        <p>
          Když ti byl meč vzat nebo jsi se od něj musel vzdálit, pracuj šavlí a
          zápasem – přistup k němu a hlavicí udeř pod oči. Sleduj, zda mu
          dokážeš sevřít nohu nebo mu ji podkopnout a podrazit.
          <br />
          Dále, když jsi přišel o svůj meč a protivník má obě zbraně vytažené,
          drž se v dolním střehu a čekej pravou rukou, jestli mu dokážeš uchopit
          jeho meč, a se šavlí čekej jeho úderu. Sleduj, zda můžeš získat výhodu
          proti jeho levému lokti – dýkou bys teď neměl bojovat, pokud ho už
          nemáš shozeného.
          <br />
          Když ho srazíš, zachyť jeho pravou paži svým levým kolenem a levou
          rukou mu přitlač krk. Pravou rukou uchop jeho levou a levou rukou
          pomoz pravé. Pak vytáhni svou dýku a pracuj mezi klouby tam, kde to
          považuješ za nejnebezpečnější. A když mu takto klouby přerušíš,
          stiskni pružinu a bodni menší čepelí mezi
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          oddělené klouby. Dále nech dýku zcela volnou se všemi hroty a pracuj
          její menší čepelí k helmě, kde je otevřená. Kde se nacházejí další
          odkrytá místa, bylo už dříve popsáno.
          <br />
          Když padne na břicho, padni na jeho klouby paže svým kolenem a zlom mu
          paži. Také mu padni na západky brnění na zádech.
          <br />
          Když ho shodíš, bodni ho do země a naplň mu hledí nebo mu vyřízni něco
          z jeho wappenrocku (kabátce s erbem) a zacpi mu hledí. Potom pracuj
          dýkou do slabin nebo mezi klouby nebo bodni před jeho srdce nebo do
          kloubů, kde jsou nejslabší.
          <br />
          Nakonec je třeba si uvědomit, že během všech těchto cvičení a zápasů
          se některé techniky v různých zbraních opakují – proto jsem je sepsal
          stručně, aby se stejné věci zbytečně neopakovaly. Také protože je šerm
          a boj veden tak, že zkušený v tomto umění by měl vidět svou výhodu i u
          neznámých zbraní, proto jsem to všechno sepsal tak, aby byla jedna
          zbraň propojena s druhou – aby tak každý
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          ...
          auch Inns Rapir firtt / her¬ wüderumb aus dem Rapür Inn dusackenn /
      ...
      <Col>
        <p>
          kdo se chce cvičit a sladit jednu zbraň s druhou – tedy co se naučí u
          meče, ať to zkusí i s dusakem. Také co se naučí s dusakem, ať to
          přenese k rapíru, a z rapíru zpět k dusaku. Stejně tak zápas a chvaty
          s dýkou do boje v brnění. Takto to platí i pro delší zbraně, jako jsou
          hole, halapartny a kopí. Kdo se bude řídit tímto pravidlem, ten z této
          knihy získá užitek a mé úsilí mu bude prospěšné. Jak je to více určeno
          k učení než k pouhému předvádění.
        </p>
      </Col>
    </Row>
  </>
