...
export const ValecneKladivo = ({ draft }: ArticleProps) => (
  <>
    <Row>
      <Col>
        <h1>Válečné kladivo{draft && <DraftBadge />}</h1>
      </Col>
    </Row>
    <Row>
      <Col>
        <h4>Úvod</h4>
        <p>
          S vývojem plátové zbroje a nástupem pěchoty coby hlavní bojové síly v
          průběhu 14. a 15. století se také vyvíjel design pěchotních dřevcových
          zbraní, v českém prostředí zvaných kúsy, různě kombinující možnost
    ...
    <Row>
      <Col md={4}>
        Obrázek 1: Obouruční kladivo z muzea umění ve Worcestru, Německo, kolem
        roku 1440.
        <table>
          <tbody>
            <tr>
      ...
      <Col md={4}>
        Obrázek 2: Jednoruční kladivo z Metropolitního muzea umění v New Yorku,
        Francie, kolem roku 1450.
        <table>
          <tbody>
            <tr>
              <th>Délka:&nbsp;</th>
      ...
      <Col md={4}>
        Obrázek 3: Lucernské kladivo z Filadelfského muzea umění, Švýcarsko,
        1500.
        <table>
          <tbody>
            <tr>
