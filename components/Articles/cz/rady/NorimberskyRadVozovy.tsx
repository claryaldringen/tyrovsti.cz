      ...
      <Col md={6}>
        ...
        <ol>
          ...
          <li>
            ...
            vůz, ke každému vozu 20 olověných kulí, označených dvěma šípy; koule
            ve své truhličce; u každého vozu tři koně.
          </li>
          <li>
          ...
          <li>
            ...
            tolik věcí jako předtím; nýbrž o to méně děl musí vzít s&nbsp;sebou,
            ať se jedná o sraz jako před Spaltem, ale kamenů stačí polovina.
          </li>
          <li>
            Jako první jsme vzali s&nbsp;sebou dva vozy s&nbsp;prachem, lehkými
            šipkami, zápalnými šípy a zápalnými kulemi, u&nbsp;jednoho vozu
            čtyři koně.
          </li>
          ...
          <li>
            Ke každému uvedenému vozu se také přidal jeden řetěz u 1½ sáhu (asi
            2.6 m) dlouhý; kdyby jeden chtěl uzavřít vozovou hradbu, a jeden
            tyto řetězy eviduje, že kdyby je půjčil, tak ať ví, u koho je
            požadovat zpět.
          </li>
          <li>
            Každému správci čtvrti se zde poslalo z&nbsp;města 25 kopí a 25
            halaparten, které předají nebo půjčí svým hejtmanům, když vyrazí do
            pole, a jeden druhému půjčí zbraň, kterou nemá nebo by chtěl mít,
            jak je předem psáno.
          </li>
          <li>
            Navíc se ke každému vozu objedná jedna velká plachta, která se vezme
            s&nbsp;sebou, když se vyrazí do pole, aby se v&nbsp;případě nouze do
            ní zabalili.
          </li>
          <li>
