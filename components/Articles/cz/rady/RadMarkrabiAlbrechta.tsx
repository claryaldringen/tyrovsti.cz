  ...
  <>
    ...
    <Row>
      ...
      <Col md={6}>
        <ol>
          <li>
            Nikdo nesmí žádného přítele poškodit na těle a statku nebo oloupit
            ani provádět žádné hanebnosti s těmi, kteří jsou přivedeni do
            vojska. Kdož takto činí, bude bez milosti potrestán mečem, jak praví
            při loupeži zákon.
          </li>
          <li>
            Všichni, kdož sváry podněcují, budou potrestáni podle uvážení mého
            milostivého pána a rádců jeho milosti, které jeho milost bezpečně
            k&nbsp;němu přivede, a každý tak, jak mu náleží.
          </li>
          <li>
            Kdež ale nastanou sváry, které se neukázaly po opuštění trestu,
            nesmí nikdo po opuštění těla k druhému přiběhnout, kromě těch k tomu
            jmenovaných, ti se musí oddělit a jednat podle pokynů mého
            milostivého pána a hejtmanů. Neboť když to bude tak, že každý
            přiběhne, pak se pobijeme všichni navzájem; jinak je možné to lehce
            uřídit; přitom se nesmí k nikomu přihlížet, ať z přátelství ani
            jakéhosi příbuzenství, ale hledat v tom obecný užitek k prospěchu
            mého milostivého pána, panstva a vojska. A kdož se vzpírá
            potrestání, má mužně pomoci těm, kteří jsou k tomu určeni, aby
            trestali a udržovali pořádek.
          </li>
          <li>Kdož krade, bude bez milosti potrestán oprátkou.</li>
          <li>
            Kdož okrade přítele, bude bez milosti potrestán podle uvážení mého
            milostivého pána nebo hejtmanů jeho milosti podle povahy věci.
          </li>
          <li>
            Nikdo nesmí přivést proviant, než budou všichni v noci svoláni, ani
            vycházet bez povolení mého milostivého pána nebo hejtmana. Kdož tak
            učiní, neručí se mu za žádnou škodu, pokud by něco ztratil.
          </li>
          <li>
            Nikdo nesmí vykopat ve vojsku žádnou jámu, aby se lidem nebránilo v
            jízdě a chůzi.
          </li>
          <li>Ve vojsku je třeba být tiše.</li>
          <li>
            Každý, kdo chce přivést proviant, musí počkat na korouhev a vůz a
            všichni musí jet, jít a vést se podle korouhve; a musí složit
            proviant tam, kde se jim ukáže, při sobě, dohromady; a jestli na
            jednom konci nebudou moci najít proviant, přece nesmí nikdo jet nebo
            jít domů, dokud se všichni nebudou nasyceni; a dále jet společně,
            kde se najde proviant; a musí pak, jakmile se všichni nasytí, v
            pořádku opět táhnout domů, jak vyrazili. A Nikolassken musí táhnout
            s vozy a trabanty, kolik jich zvládne.
          </li>
          <li>
            Hejtmanovi, který se stará o proviant, se přiřadí všechny cesty,
            které bude hlídat, aby uchránil lid.
          </li>
          <li>
            Kde se chce přijímat proviant, musí se prohlédnout všechny cesty
            předem.
          </li>
          <li>
            Každé ráno, ať ve městě nebo v poli, se musí vyslat pacholci, kterým
            je třeba uložit, aby prohlédli všechny věci, než se vyrazí k
            proviantu nebo něčemu jinému, a po nich opět uzavřít, dokud zase
            nepřijdou.
          </li>
          <li>
            Pro udržení pořádku se vojsko rozdělí do osmi oddílů, aby se po
            všechny dny uchovala pro každý oddíl proviant tam, kde je nouze.
            Těmto oddílům se pak přidělí dělo, aby se v osmi dnech zase sloučily
            v jeden.
          </li>
          <li>
            Tam, kde se umístí dělo, položí se k&nbsp;nim tisíc mužů, mezi nimi
            200 jezdců s vozovými pacholky a všemi, kteří se u děl skryjí do
            zákopů, aby se děla všude uchránila a nesměla se po všechny dny
            měnit.
          </li>
          <li>
            Aby se nikdo nehnal z vojska nebo z měst, nýbrž aby se každý při
            zvuku trubky posunul na místo do houfu, ať ve vojsku nebo ve městě,
            a zůstal takto v řadě tak dlouho, aby si ho mohli hejtmani
            zkontrolovat a poradit, co může dělat; a on pak utajeně prováděl
            svou činnost.
          </li>
          <li>Ustanovit hlídače houfu ve dne, v noci podle potřeby.</li>
          <li>
            Zařídit nad každou řadou jednoho hejtmana, který ví po všechny noci,
            zda se jeho řada zvětšuje nebo zmenšuje, nebo kdož cizí do ní
            vstoupí, aby ho hejtmani uměli odhalit.
          </li>
          <li>
            Ustanovit ve vnějších řadách vojska znalce, v každé čtvrtině dva,
            aby se po všechny dny a noci vědělo, že je vozová hradba chráněna.
          </li>
          <li>
            Po všechny noci udržovat vždy u každých 10 vozů malý oheň, na jeden
            hod kamenem od vozové hradby.
          </li>
        </ol>
      </Col>
    </Row>
