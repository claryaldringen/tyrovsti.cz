    ...
    <Row>
      <Col>
        <p>
          ...
          rota nebo Černá legie, jsou názvy pro pozdně středověké uherské
          žoldnéřské vojsko ve službách krále Matyáše Korvína. Zrod tohoto
          žoldnéřského vojska započal už za vlády jeho otce Jánose Hunyadiho
          kolem roku 1440, ovšem s myšlenkou zavedení stálé profesionální
          žoldnéřské armády přišel až Matyáš Korvín, čímž se pravděpodobně
          inspiroval ze svého mládí, když četl o životě římského vojevůdce Julia
          Caesara. Žoldnéřské vojsko existovalo mezi lety 1458 až 1494. Oproti
          jiným vojskům byla Černá rota stálou profesionální žoldnéřskou
          armádou, se kterou Matyáš dosáhl mnoha vítězství a úspěchů.
        </p>
        <p>
          Matyáš rozpoznal důležitost a klíčovou roli pěchotních palných zbraní,
          jež následně významně přispěly k efektivitě a úspěchům. Zhruba každý
          čtvrtý příslušník Černé armády byl vybaven arkebuzou, což byl v té
          době neobvyklý poměr. Jen vysoká cena střelného prachu ve středověku
          jim bránila v tom, aby byl tento počet ještě víc navýšen. Dokonce i po
          desetiletí po rozpadu Černé armády, na přelomu 16. století, asi jen
          10% vojáků západoevropských armád používalo palné zbraně. Hlavními
          složkami Černé armády byly pěchota, dělostřelectvo a lehká i těžká
          jízda. Funkce těžkého jezdectva měla chránit lehkou obrněnou pěchotu a
          dělostřelectvo, zatím co ostatní sbory dodávaly nepřátelům sporadické,
          překvapivé útoky. V počátcích se jádro armády skládalo z 6 000–8 000
          žoldnéřů. V roce 1480 se počet pohyboval mezi 15 000 a 20 000, nicméně
          na velké vídeňské vojenské přehlídce v roce 1485 dosáhla Černá armáda
          počtu až 28 000 mužů (20 000 jezdců a 8 000 pěšáků). Vojáci pocházeli
          z různých zemí a národů, byli mezi nimi především Češi, Bavoři,
          Srbové, Poláci, Chorvati a od roku 1480 také Maďaři. Černá armáda byla
          tedy mnohem větší žoldnéřskou armádou, než armáda francouzského krále
          Ludvíka XI., jediné další stálé profesionální armády v Evropě.
        </p>
        <p>
          Prvotním základem Černé armády se stalo 500 težkooděných jezdců, které
          Matyášovi v roce 1458 zapůjčil český král Jiří z Poděbrad. Postupně k
          nim přičleňoval zbytky bratříků a jiných českých žoldnéřů
          nacházejících se v té době v Horních Uhrách a na základě mírové
          smlouvy z Vídeňského Nového Města z <b>19. července 1463</b> získal do
          svých služeb i Jana Jiskru z Brandýsa s jeho českými žoldéři.
        </p>
      </Col>
    </Row>
    <Row>
      <Col>
        <h5>Typy zbraní</h5>
        <p>
          <b>Těžká jízda</b> Nejdůležitějším typem zbraně, tím, který rozhodoval
          velké bitvy, byla stále těžká jízda a její početní podíl v armádě se
          ve srovnání s předchozím obdobím také zvýšil. Většinou se dělila na
          podjednotky zvané legie , což odpovídalo „rytířskému praporu“ nebo
          později jezdeckým rotám (asi 100 mužů), které byly rozděleny do
          25členných oddílů neboli <i>turm</i> v tehdejší latině . S příchodem
          dělostřelectva a posílením role lehké jízdy strategický význam těžké
          jízdy klesal, ale velké bitvy – ačkoli k nim během tažení docházelo
          stále méně často – byly i nadále rozhodovány tímto typem zbraně (Bitva
          na říčce Valové 1471, Bitva na Chebovém poli 1479, Leitzensdorf 1484,
          Thomaswalde 1488).
        </p>
        <p>
          ...
          „českou, rácskou(srbskou) a uherskou“. Rozdíl zde znamená nejen
        ...
        <p>
          Organizace lehké jízdy Matyáše odpovídala organizaci těžké jízdy, tj.
          byla rozdělena na legie a <i>turmy</i>. Její význam vzrostl také
          proto, že podle Mátyšovy strategie a taktiky docházelo k větším
          střetům s Turky jen zřídka, ale naopak se ustálily nájezdy na
          pohraniční oblasti, což bylo pro husary životně důležité.
        </p>
        <p>
          <b>Pěchota</b> Zpráva benátského vyslance z roku 1479 odhadovala
          celkový počet uherských pěšáků na 16 000. Z nich 6 000 pocházelo z
          Uher a Transylvánie a 10 000 z Čech. Matyáš popsal organizaci a bojový
          styl této pěchoty v jednom ze svých četných dopisů:
          <br />
          <Cit>
            ...
            pugnant, et data opportunitate eruinpunt; (Ve třetím sledu jsou
            pěšáci, a ti se dělí do různých tříd: někteří jsou řadoví pěšáci,
            jiní obrnění, někteří štítonoši. Řadoví vojáci čili pěšáci chtějí za
            každou angarii (vojenskou povinnost za jednoho muže) dostat 8
            ...
            pěchoty jakýkoli, pětina z nich se sestavuje ze střelců z
            ručnic...těžce ozbrojení bojovníci jsou u nás považováni za zeď,
