...
export const BitvaUVarny = () => (
  <>
    <Row>
      <Col>
        <div className="anchor" id="bitva-u-varny" />
        <h4>Bitva u Varny (1444)</h4>
        <p>
    ...
    <Row>
      <Col>
        ...
        <p>
          ...
          předmětem diskusí.
          <Qt
            publication={PUBLICATIONS.CALLIMACHUS_VARNENSI}
            href="https://archive.org/details/jbc.bj.uj.edu.pl.NDIGSTDR009201/page/n59/mode/2up"
          />
        </p>
        <h5>Výsledek</h5>
        <p>
