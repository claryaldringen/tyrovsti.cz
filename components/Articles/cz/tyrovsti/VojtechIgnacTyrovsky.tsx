...
export const VojtechIgnacTyrovsky = () => (
  <>
    <Row>
      <Col>
        <div className="anchor" id="vojtech-ignac-tyrovsky-z-einsiedlu" />
        <h4>
          Vojtěch Ignác Týřovský z Einsiedlu (zemřel 1695) a konec rodu na
          Chříči
        </h4>
        <p>
        ...
        <p>
          Kožlanské se pokusil přivést k úplnému podmanění: vyžádal si od nich
          všechna privilegia k nahlédnutí, a když je po několika letech
          nevracel, postihli měšťané pánovu lest a stěžovali si u české komory.
          Na rozkaz krajského hejtmana jim roku 1680 výsady vrátil. Za jeho
          panování opustilo sedm kožlanských poddaných své statky a sběhlo. Když
          se roku 1680 Čistečtí domáhali výročních trhů a cla, odporovali
          Kožlanští trhům i clu a jejich dědičný pán tvrdil, že Břežanská hora
          náleží jemu, neboť ji jeho předkové koupili od Albrechta Jindřicha z
          Kolovrat.
          <Qt
            publication={PUBLICATIONS.KOCKA1}
        ...
        <p>
          Ke kostelu v Milíčově, kde ležel jeho děd, dal roku 1665 přistavět věž
          a opatřil oltář.
          <Qt
            publication={PUBLICATIONS.KOCKA1}
