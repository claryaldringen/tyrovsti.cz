...
export const AdamJindrichTyrovsky = () => (
  <>
    <Row>
      <Col>
        <div className="anchor" id="adam-jindrich-tyrovsky-z-einsiedlu" />
        <h4>Adam Jindřich Týřovský z Einsiedlu (zemřel 1652)</h4>
        <p>
          Adam Jindřich byl při otcově smrti roku 1618 nezletilý, což ho
          pravděpodobně zachránilo. Roku 1621 byl sice obeslán před konfiskační
          komisi, ale protože neměl právních let, na dvojí obeslání se
          nedostavil; teprve roku 1629 byl před komisí tractationis osvobozen,
          neboť se odboje osobně neúčastnil, a otcovské statky Chříč,
          Hřebečníky, Broumy a Kožlany mu byly ponechány.
          <Qt
        ...
        <p>
          Jeho poručník Bohuslav Jiří Krakovský mezitím na Chříči zle
          hospodařil. Roku 1624 na něj Dorota Týřovská žalovala, že sirotky
          ochuzuje, že odvezl a prodal obilí, dobytek a jiné věci.
          <Qt
            publication={PUBLICATIONS.KOCKA1}
            href="https://kramerius5.nkp.cz/view/uuid:cbd24070-4608-11ed-b64c-005056827e52?page=uuid:7e24d610-e020-4b49-94be-10a7485249aa"
            note="Str. 314–315"
        ...
        <p>
          Roku 1627 došel Adam Jindřich plných let a uvázal se v zadlužené
          statky; hospodařil na nich s úředníkem Václavem Kulíškem. Aby mohl
          zpustošený statek obdělávat, vydlužil si od Viléma z Klenového na
        ...
        <p>
          Téhož roku 1631 vtrhli do Rakovníka Sasové a Týřovský byl posléze
          obviněn, že na náměstí vítal hejtmana Ploskovského, zakázal se mu za
          rytmistra, s manželkou jezdil po kraji, dodával Sasům zprávy, potýkal
        ...
        <p>
          Válka se přes Chříč převalila ještě dvakrát. Roku 1637 se v okolí
          honila nepřátelská vojska a Chříč popálila, takže se Adam Jindřich
          zdržoval v Praze, kde koupil dům od berního registrátora Kačerovského.
          V březnu 1640 přitáhl císařský plukovník Václav Zahrádecký s dvěma
          pluky k Podmoklům, vše popálil a hnal se přes brod na Chříč; Týřovský
          sehnal na výpalné 300 zlatých a tím se nepřítele zhostil.
          <Qt
            publication={PUBLICATIONS.KOCKA1}
            href="https://kramerius5.nkp.cz/view/uuid:cbd24070-4608-11ed-b64c-005056827e52?page=uuid:7c883e9c-c039-4e28-8217-2e3df2340137"
            note="Str. 315"
