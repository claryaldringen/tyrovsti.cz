    ...
    <Row>
      <Col>
        ...
        <p>
          ...
          Plavna, první, dosud dochovaný, dopis městu Cheb.
          <Qt
            publication={PUBLICATIONS.KURSCHNER}
            href="https://sources.cms.flu.cas.cz/src/index.php?s=v&cat=50&bookid=488&page=5"
          />{' '}
          Cheb byl totiž ohrožován vracejícím se českým vojskem, neboť v březnu
          1450 odmítla chebská rada vpustit do města Jiřího z Poděbrad a jeho
          straníky na jednání s německými knížaty, které se tak muselo konat ve
    ...
    <Row>
      <Col>
        ...
        <p>
          ...
          vyžadovaly zvláštní péči a spolehlivost. Jeden takový případ nastal
          bezprostředně po zvolení Jiřího králem. Když se totiž na velkém
          volebním sněmu v Praze&nbsp;
          ...
          významnou událost s neskrývanou radostí a sdělil to ihned do Chebu,
          kde byla tato zpráva radostně přijata (zachovala se pouze odpověď z
          Chebu). Protože se Jiří proslavil již v dřívějších letech horlivou
          péčí o udržení míru, muselo být pro město jako Cheb, které leželo na
          hranicích různých oblastí a provozovalo čilý obchod, jeho zvolení
          obzvláště žádoucí. Nadto ujistil Jošt chebské měšťany královou přízní
          a napomínal je, aby ani trochu nedbali pomluv a hrozeb svých sousedů,
          nýbrž zůstali pevní a neochvějní. Pro Jošta samotného mělo zvolení
          Jiřího i další důsledek, a sice ten, že ho nový král ještě v létě
          korunovačního roku pozvedl do rytířského stavu, jak dokládá gratulace
          Chebských z&nbsp;
          <b>29. července 1458</b>
          <Qt
            publication={PUBLICATIONS.KURSCHNER}
            href="https://sources.cms.flu.cas.cz/src/index.php?s=v&cat=50&bookid=488&page=7"
          />{' '}
        ...
        <p>
          ...
          má na mysli Jošt ve svém zajímavém dopise ze &nbsp;
