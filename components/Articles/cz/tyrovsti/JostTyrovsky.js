    ...
    <Row>
      <Col>
        ...
        <p>
          ...
          jazykům, se doporučovali především těm českým pánům, kteří neovládali
          němčinu, ačkoli ji nemohli při svém častém kontaktu se sousedními
          německými oblastmi postrádat. Takto např. omlouvá pan Jan z Házmburka
          svůj dopis městu Cheb sepsaný v českém jazyce tím, že momentálně nemá
          svého německého písaře po ruce. V této funkci se také Jošt skutečně
          objevuje ve službách pánů Aleše a Petra Holických ze Šternberka, kteří
          v té době byli majiteli nedalekého Bečova nad Teplou.
        </p>
        <p>
          ...
          bratrovražedné války (1446 - 1451). Vojsko se mělo shromáždit u Chebu,
          přičemž Joštovi byly svěřeny administrativní a organizační
          záležitosti, když v dopise ze <b>13. února 1447</b> vévoda Vilém píše:
          <i>
        ...
        <p>
          ...
          arcibiskupa Dětřicha II. v tzv. Soestském sporu. Protože vrchním
          velitelem celého českého sboru byl Petr Holický ze Šternberka, lze
        ...
        <p>
          ...
          <b>4.&nbsp;června&nbsp;1450</b> v čele své strany tažení proti jejím
          spojencům, zejména vévodovi Friedrichu Saskému, přičemž bylo dobyto
          město Gera a den na to&nbsp;
          <b>23.&nbsp;října&nbsp;1450</b>(některé zdroje uvádějí&nbsp;
          <b>16. října 1450</b>) uzavřeno příměří.
        </p>
        <p>
          Jošt z Einsiedle, který se účastnil tohoto tažení v družině pána Petra
          Holického ze Šternberka, napsal&nbsp;
          ...
          jednání s německými knížaty, které se tak muselo konat ve Wunsiedelu.
          V dopise Jošt měšťany varoval a nabádal je, aby se pokusili o dohodu.
          Zprostředkování se ujali Aleš a Petr Holičtí ze Šternberka, kteří se
          svým sekretářem Joštem z Einsidle zajistili chebským poslům bezpečný
          glejt. Jednání se konalo na hradě Skalné (Vildštejně). Cestou na
          schůzku však byli chebští diplomaté, nesoucí mj. dary pro Jiřího z
          Poděbrad, přepadeni a oloupeni. S nimi byl přepaden rovněž Jošt z
          Einsidle, který si zachránil život slibem, že pachatele neprozradí.
        </p>
        <p>
        ...
        <p>
          ...
          Jošt tuto významnou událost s neskrývanou radostí a sdělil to ihned do
          Chebu, kde byla tato zpráva radostně přijata (zachovala se pouze
          ...
          zvolení obzvláště žádoucí. Nadto ujistil Jošt chebské měšťany královou
          přízní a napomínal je, aby ani trochu nedbali pomluv a hrozeb svých
        ...
        <p>
          Aby však král mohl splatit svůj dluh pražskému purkrabímu Zdeňkovi ze
          ...
          purkrabího, který mu byl povinnen půjčit psy a tenata.
        </p>
        <p>
        ...
        <p>
          ...
          přímluvu. Ten byl ochotný podat informace, pokud se nejednalo o úřední
          tajemství, které vždy rozhodně zachovával. Ale také jinak jedná s
          velkou opatrností, a jakkoli je tato rovněž chvályhodná, překvapí
          nepříjemně čtenáře, když např. uprostřed zajímavého dopisu stojí:
          <i>
        ...
        <p>
          ...
          Chebu, aby oznámil příjezd krále o postní neděli&nbsp;
        ...
        <p>
          ...
          na Karlštejně do Prahy a jejich kontrolou.
        </p>
        <p>
          ...
          mnohých sekt. Jednu takovou má na mysli Jošt ve svém zajímavém dopise
          ze &nbsp;<b>17. září 1466</b>. Ten je spojen se jmény Liwina a Janka z
          Wirsbergu, františkánských apokalyptických kazatelů působících na
          Chebsku a ovlivněných kázáními Jana Kapistrána a kázáním Jana Rokycany
          v Chebu roku 1451. Z obavy před interdiktem a také kvůli tomu, že se
          proti učení Wirsbergů vymezil i král Jiří, zakázala městská rada
          Wirsbergům vstup do města. Jošt se jeví ve svém dopise jako horlivý
        ...
        <p>
          ...
          výčitky, přesto musí vytrpět všechny obtíže; neboť jako katolík má za
          nepřátele utrakvisty a jako přívrženec exkomunikovaného krále vlastní
          souvěrce, z jejichž společenství ho přece církev vyloučila. Jeho
          statky jsou pustošeny, jeho poddané vesnice páleny a ničeny (svou
          škodu vyčísluje na 300 kop grošů). Král Jiří škodu uznává a a roku
          1466 mu připisuje 100 kop grošů na stavbu rybníků a uděluje milost, že
          jeho syn Jindřich nebude moci být do své smrti z Týřova vyplacen.
        ...
        <p>
          Roku 1472 získává od krále Vladislava pro Kožlany městská práva stejná
          jako má Rakovník, erb a povolení vystavět v Kožlanech pivovar. Od
