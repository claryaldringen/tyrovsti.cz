    ...
    <Row>
      ...
      <Col md={6}>
        <ol>
          ...
          <li>Dorthin, außerhalb der Front...</li>
          <li>
            ...
            sowie die Eroberung von Burgen graben, und VIII gut gerüstete
          ...
          <li>
            Unter den tausend Wagen müssen IV Wagen sein, die für die äußerste
            ...
            zwischen den Rädern ein angehängtes Brett. Diese selben IIII Wagen
            müssen auch Ketten haben, um sie zusammenzuschließen. Und die
            anderen VI Wagen sollen Seile haben, um sie wie die übrigen Wagen zu
            sperren, und alle müssen nach dem Muster gefertigt sein, das wir in
