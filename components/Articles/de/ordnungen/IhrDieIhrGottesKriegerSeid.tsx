...
export const IhrDieIhrGottesKriegerSeid = () => (
  <>
    ...
    <Row>
      <Col>
        <p>
          ...
          Gnade.
          <br />
          5. Strophe - Fürchtet euch nicht vor der Übermacht und flieht nicht
          aus der Schlacht. <br />
          6. Strophe - Wenn der Anführer tüchtig ist, wird der Feldzug gelingen.
          <br />
          7. Strophe - Tötet nicht um der Beute willen und haltet nicht an, um
          zu plündern.
          <br />
    ...
    <Row>
      ...
      <Col md={6}>
        <p>
          <b>Ihr, die ihr Gottes Krieger seid</b>
          <br />
          <br />
        </p>
        <p>
