...
export const Bibliographie = ({ draft }: ArticleProps) => (
  <>
    <Row>
      <Col>
        <h1>Quellen{draft && <DraftBadge />}</h1>
        <h2>Primärquellen</h2>
        <h3>Böhmische</h3>
        <ul>
          <li>
            <a
              ...
              target="_blank"
            >
              Památná kniha olomoucká (Gedenkbuch von Olmütz)
            </a>
          </li>
          <li>
            <a
              ...
              target="_blank"
            >
              Fresko aus der Münzerkapelle, Katharinenkathedrale der Hl.
              Barbara, Kutná Hora
            </a>
          </li>
          <li>
            <a
              ...
              target="_blank"
            >
              St.-Georgs-Altar (Svatojiřský oltář)
            </a>
          </li>
          <li>
            <a
              ...
              target="_blank"
            >
              Puchner-Arche (Puchnerova archa)
            </a>
          </li>
          <li>
            <a
              ...
              target="_blank"
            >
              Altarflügel aus Roudníky (Oltářní křídla z Roudník)
            </a>
          </li>
          <li>
            <a
              ...
              target="_blank"
            >
              Kuttenberger Bibel (Kutnohorská Bible)
            </a>
          </li>
          <li>
            <a
              ...
              target="_blank"
            >
              Antithesis Christi et Antichristi (Jenaer Kodex)
            </a>
          </li>
        </ul>
      </Col>
        ...
        <ul>
          <li>
            <a
              ...
              target="_blank"
            >
              Chronicon Concilii Constantiensis (Kleine Richental-Chronik)
            </a>
          </li>
          <li>
            <a
        ...
        <ul>
          <li>
            <a
              ...
              target="_blank"
            >
              Lederverarbeitung in den böhmischen Ländern im Mittelalter
          ...
          <li>
            <a
              ...
              target="_blank"
            >
              Der Wandel der Kleidungsstile während der Hussitenkriege (Proměna
              stylu odívání v průběhu husitských válek)
            </a>
          </li>
          <li>
            <a
              ...
              target="_blank"
            >
              Der Rakovníker Altar (Rakovnický oltář)
            </a>
          </li>
          <li>
            <a
              ...
              target="_blank"
            >
              Zunftartikel der Prager Zünfte (Artikule cechů pražských)
            </a>
          </li>
          <li>
            <a
              ...
              target="_blank"
            >
              Freskenausstattung des Schlosses Žirovnice (Fresková výmalba zámku
              v Žirovnici)
            </a>
          </li>
          <li>
            <a
              ...
              target="_blank"
            >
              Sammelband des Hussitischen Museums in Tábor (Schlacht bei
              Schönberg 1504)
            </a>
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            <a
              ...
              target="_blank"
            >
              Grabstein des Vilém von Ilburk, nach 1489
            </a>
          </li>
          <li>
            <a href="https://www.esbirky.cz/predmet/7592512" target="_blank">
              Doppelseitiges Tafelgemälde der Gefangennahme Christi, um 1500
            </a>
          </li>
          <li>
            <a href="https://www.esbirky.cz/predmet/3510952" target="_blank">
              Epitaph des Půta Švihovský von Rýzmberk, 1504
            </a>
          </li>
        </ul>
      </Col>
