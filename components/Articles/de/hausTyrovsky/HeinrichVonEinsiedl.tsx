...
export const HeinrichVonEinsiedl = () => (
  <>
    <Row>
      <Col>
        <div className="anchor" id="henry-of-einsiedl" />
        <h4>Jindřich (Heinrich) Týřovský von Einsiedl (um 1466–1556)</h4>
        <p>
        ...
        <p>
          ...
          Kožlany kaufte er zwei verödete Bauernhöfe mit Einkünften, die viele
          Jahre lang zu Krakovec gehört hatten, von Jindřich Albrecht von
          Kolovrat, und legte oberhalb des Städtchens einen Teich mit
          Rohrleitung an.
          <Qt
