  ...
  <>
    ...
    <Row>
      <Col>
        <p>
          ...
          formare una base per la pittura con colori a tempera.
        </p>
        <p>
          Le targhe, come altri scudi, erano realizzate per lo più da artigiani
          specializzati chiamati scutari, che avevano stretti legami con i
          pittori. Nel 1348, i pittori e gli scutari delle città praghesi
          fondarono la Confraternita di San Luca
          <Qt publication={PUBLICATIONS.DENKSTEIN3} note="p. 20" /> e vi
          includevano anche artigiani affini, come vetrai, legatori di libri,
          intagliatori, pergamenai, orafi, miniaturisti, incisori su rame e
          altri.
          <Qt
          ...
          />
          Tuttavia, all&apos;interno della Confraternita sorsero presto dispute
          tra pittori e scutari, come testimoniano i privilegi concessi da Carlo
          IV e Venceslao IV. Gli scutari fabbricavano scudi, oltre ad alcuni
          pezzi di selleria e insegne domestiche, incluse le loro decorazioni
          pittoriche. I pittori (magistri pictoriae artis, pittori spirituali,
          geistliche Maler) dipingevano immagini e altari, ma a volte si
          appropriavano del lavoro degli scutari e impedivano loro di esporre e
          vendere i propri prodotti ai mercati della Città Vecchia (Praga),
          poiché gli scutari avevano sede sotto le mura e le torri della Città
          Nuova (Praga) e dovevano svolgere e vendere il loro lavoro lì.
          <Qt publication={PUBLICATIONS.DENKSTEIN3} note="p. 20" />
        </p>
        <p>
          La disputa fu risolta da un privilegio concesso da Carlo IV il{' '}
          <b>16 gennaio 1365</b>: gli scutari, stabiliti sulle torri delle mura
          della Città Nuova, furono — come i tiratori — esentati insieme ai loro
          servitori da tutte le tasse, i servizi e le imposte, ma erano tenuti a
          servire il re o il suo maresciallo in caso di necessità (per la difesa
          della città). Pertanto, era loro consentito portare spada, coltello e
          armatura (harnisch) come i tiratori, per difendere le mura cittadine.
          Nella disputa con i <Cit>pittori spirituali</Cit>, che non volevano
          tollerare gli scutari (ossia sopportare i loro obblighi verso la
        ...
        <p>
          ...
          (tavole, archi, stendardi, bandiere, candele dorate e di legno,
          equipaggiamento equestre piccolo o grande, pavesi, targhe e altri
        ...
        <p>
          ...
          <Cit>dříví jezdecké malé nebo velké</Cit> (equipaggiamento equestre
          piccolo o grande), che, per la lavorazione impegnativa, non era un
          normale lavoro da sellaio e apparteneva alle merci dipinte.
          All&apos;interno della corporazione nel XIV secolo, era probabilmente
          opera degli scutari piuttosto che dei maestri di{' '}
        ...
        <p>
          Secondo il preambolo nel privilegio del 1458, i maestri della Città
          Vecchia dei mestieri di pittura e vetreria erano
          <Cit>
        ...
        <p>
          Queste <Cit>antiche lettere</Cit> sono datate più precisamente nella
          frase successiva di questo preambolo:
          <Cit>
          ...
          (Consideriamo e comprendiamo che la Città Nuova non era ancora
        ...
        <p>
          Tuttavia, i maestri della Città Vecchia fornirono i tre grandi scudi
          eretti o mantelli protettivi solo nel XIV secolo. In un momento
          imprecisato, al più tardi prima delle guerre hussite, la disposizione
          cambiò in modo che, al posto dei tre grandi mantelli protettivi,
          dovessero fornire 10 pavesi alla città. Ciò è evidente da un registro
          nei libri fondiari della Città Vecchia datato <b>7 febbraio 1430</b>,
        ...
        <p>
          ...
          1430. La delibera del consiglio della Città Vecchia del{' '}
          <b>13 novembre 1458</b> fu pertanto una conferma dei privilegi
          cumulativi, sia vecchi che nuovi. Così va intesa la delibera del
          consiglio della Città Vecchia del <b>13 novembre 1458</b>:
          <Cit>
          ...
          (... pertanto li manteniamo in queste grazie, diritti e libertà,
          esentandoli dalle guardie affinché, al posto dei grandi mantelli sopra
          menzionati, forniscano ogni anno nella festa di San Gallo otto pavesi
          dipinti, ben nervati e ricoperti di cuoio su entrambi i lati, e li
          portino al municipio).
          <Qt publication={PUBLICATIONS.DENKSTEIN3} note="p. 23" />
        </p>
        <p>
          Anche gli scutari e i pittori della Città Nuova avevano un simile
          obbligo verso la città. Sebbene i registri sulla loro corporazione
          compaiano solo nel XV secolo, è possibile che essa esistesse già poco
          dopo la fondazione della Città Nuova e che fosse stata dotata di
          privilegi sotto Carlo IV. In una disputa che coinvolse il tiratore Jan
          Božek, accusato nel 1454 dai pittori e scutari della Città Nuova di
          sconfinare nel loro mestiere, il consiglio della Città Nuova deliberò
          di proteggere i diritti dei pittori e degli scutari
          <Cit>
        ...
        <p>
          Nel XIV secolo, tuttavia, la capacità produttiva degli scutari e dei
          pittori della Città Nuova era significativamente inferiore alla
          portata della produzione nella Città Vecchia. Ne sono prova i registri
          della loro fornitura obbligatoria annuale alla città. Negli anni
          Ottanta del Trecento, un accordo tra loro e il consiglio della Città
          Nuova risolse le annose dispute su tributi e tasse, stabilendo che gli
          scutari <Cit>kteříž pod věžemi sedí</Cit> (che siedono sotto le torri)
          senza pregiudizio per i loro diritti{' '}
          <Cit>
    ...
    <Row>
      <ImageWithTitle
        ...
        width={1920}
        height={2400}
        title="Fig. 1: Targa, Germania, intorno al 1450"
      />
      <ImageWithTitle
        md={4}
        ...
        width={1920}
        height={2036}
        title="Fig. 2: Targa, Germania, XV secolo"
      />
      <ImageWithTitle
        md={4}
        src="267737.jpg"
        width={1244}
        height={1524}
        title="Fig. 3: Targa, Germania, 1450 - 1500"
      />
    </Row>
    <Row>
      <Col md={4}>
        Sulla prima targa (Fig. 1) è dipinto uno stemma appartenente alla
      ...
      <Col md={4}>
        Sebbene la targa centrale (Fig. 2) sia danneggiata dall&apos;uso e dal
        tempo, è uno degli esemplari più splendidamente dipinti di targa del XV
        secolo. La faccia sopravvissuta raffigura una donna con un turbante
        piumato che regge un cartiglio (nastro con iscrizione) con
        l&apos;iscrizione in tedesco &ldquo;FAHR MIT FREUDEN&rdquo; (procedi con
        gioia). Lo scudo araldico sulla destra recava un tempo lo stemma del
        proprietario, ora illeggibile. Le superfici circostanti sono finemente
        dipinte con una decorazione di foglie a voluta e &ldquo;bande di
        nuvole&rdquo; in colori opachi e smalti traslucidi su fondo di lamina
        d&apos;argento lucidato.
        <table>
          <tbody>
            <tr>
      ...
      <Col md={4}>
        La superficie della terza targa (Fig. 3) è dipinta con una fine
    ...
    <Row>
      <ImageWithTitle
        ...
        width={1920}
        height={2316}
        title="Targa, Norimberga - Germania, 1440 - 1460"
      />
      <ImageWithTitle
        md={4}
      ...
      <ImageWithTitle
        ...
        width={813}
        height={1400}
        title="Dettaglio dall'ala sinistra del Polittico di Gand, 1432"
      />
    </Row>
    <Row>
      <Col>
        <p>
          ...
          Lo scudo inclinato a sinistra è sormontato sopra l&apos;angolo destro
          da un elmo, lo stesso raffigurato sulla targa della Fig. 1, e recante,
          oltre al cimiero e ai copricollo rossi con fodera argentata, anche una
          corona d&apos;oro. Nel cimiero vi è un cappello tartaro rosso con
          fodera argentata e risvolti neri. Il cartiglio con l&apos;iscrizione{' '}
          <Cit>Pomny na mye ma myla wyerna pany</Cit> (Ricordati di me, mia cara
          e fedele signora), tratto da uno sperone coevo, è collocato nello
          stesso modo della targa della Fig. 2. Sul retro è presente un disegno
          semplificato di San Cristoforo, che doveva proteggere dalla morte
          improvvisa.
        </p>
      </Col>
    </Row>
    <Row>
      <Col>
        <h5>Corpo</h5>
        <p>
          Il corpo, come la maggior parte degli scudi dell&apos;epoca, è
          realizzato con assi di tiglio incollate con colla d&apos;osso. Questo
          blocco viene poi modellato con gli strumenti fino alla forma
          definitiva. L&apos;autore del corpo è František Poch.
        </p>
      </Col>
    </Row>
    <Row>
    ...
    <Row>
      <Col>
        <h5>Rivestimento</h5>
        <p>
          Il corpo è rivestito con lino usando colla d&apos;osso. Prima del
          rivestimento, è stato necessario calafatarlo finemente. La finitura e
          il rivestimento del corpo sono stati eseguiti da Zdeněk Sedláček e
          Daniel Richter.
        </p>
      </Col>
    </Row>
    ...
    <Row>
      <Col>
        ...
        <p>
          ...
          state poi applicate sul bolo. La pittura finale è stata eseguita con
          tempera all&apos;uovo. La pittura è stata realizzata dalla Dott.ssa
          Markéta Poskočilová.
        </p>
      </Col>
    </Row>
    <Row>
      <ImageWithTitle
        ...
        width={1920}
        height={2132}
        title="Corpo rivestito"
      />
      <ImageWithTitle
        src="Gesso.JPG"
        width={1920}
        height={1920}
        title="Corpo dipinto con gesso e levigato"
      />
      <ImageWithTitle
        src="bolus.jpg"
        width={1900}
        height={1658}
        title="Corpo dopo l'applicazione di bolo armeno e nuovamente levigato"
      />
    </Row>
    <Row>
      <ImageWithTitle
        ...
        width={1920}
        height={2021}
        title="Corpo dopo l'applicazione di foglia d'argento e d'oro"
      />
      <ImageWithTitle
        src="SvKrystof.JPG"
        width={1866}
        height={2048}
        title="Disegno di San Cristoforo sul retro"
      />
      <ImageWithTitle
        src="Malba.JPG"
        width={1920}
