...
export const Armatura = ({ draft }: ArticleProps) => (
  <>
    <Row>
      <Col>
    ...
    <Row>
      <Col>
        <h4>Sviluppo dell&apos;armatura</h4>
        <p>
          Le prime testimonianze dell&apos;armatura dei nostri antenati sono
          fornite, accanto a sparsi ritrovamenti archeologici, tradizionalmente
          dalle fonti scritte. Riferimenti all&apos;armatura si trovano, ad
          esempio, nelle fonti arabe &mdash; Ibn Rusta afferma del principe
          Svatopluk che:{' '}
          <Cit>Possiede una buona, solida, preziosa armatura</Cit>. Gli Annali
          di Fulda descrivono come nell&apos;849, durante un&apos;incursione
          tedesca, i Boemi spogliarono dell&apos;armatura i Tedeschi sconfitti:{' '}
          <Cit>
            &hellip;Poich&eacute; i nemici, avendo preso il sopravvento, li
            massacrarono e li inseguirono fino al loro accampamento, e
            spogliando dell&apos;armatura i caduti davanti ai loro occhi senza
            alcuna cura, li riempirono di tale paura che persero completamente
            ogni speranza di fuga&hellip;
          </Cit>
          . Nel 936, Widukind descrive come i Tedeschi a loro volta spogliarono
          dell&apos;armatura i Boemi caduti. Ci&ograve; documenta bene uno dei
          metodi preferiti per procurarsi equipaggiamento e armi. Nella Leggenda
        ...
        <p>
          Queste prime armature erano pi&ugrave; comunemente a maglia (in antico
          ceco <i>brň</i>), ma si presuppone anche l&apos;uso di armature a
          scaglie, lamellari e faleristiche (anelli cuciti su un supporto).
          Dalla fine del XII secolo, tuttavia, fu usata esclusivamente
          l&apos;armatura a maglia. Il suo principio &mdash; anelli
          reciprocamente collegati &mdash; era gi&agrave; noto agli antichi
          Celti, dai quali i Romani lo adottarono, e come bottino di guerra
          raggiunse spesso ben oltre i confini dell&apos;impero (ad es. la
          Danimarca, dove un ritrovamento di armatura da Vimose &egrave; datato
          al II-III secolo d.C.). Dopo la caduta di Roma, la tecnologia di
          produzione di queste armature fu praticamente dimenticata in Occidente
          e sopravvisse solo a Bisanzio e nella sfera di influenza bizantina,
        ...
        <p>
          Durante il XIII secolo, le articolazioni iniziarono a essere coperte
          con piastre metalliche sagomate anatomicamente.
        </p>
        <p>
          Durante il XV secolo, la copertura di tutte le parti del corpo con
          piastre anatomiche sulla cavalleria pesante prevalse definitivamente
          sulla maglia (in antico ceco <i>brn&iacute;</i>), che continu&ograve;
          a essere usata solo come complemento. L&apos;armatura si
          differenzi&ograve; inoltre gradualmente secondo il suo uso previsto in
          armatura da campo, che preservava la mobilit&agrave; di chi la
        ...
        <p>
          ...
          centri europei di produzione di armature emersero nell&apos;Italia
          settentrionale (Milano), nella Germania meridionale (Norimberga,
          Augusta e Landshut) e nel Tirolo (Innsbruck). In questi centri di
          produzione di armi nacquero forme stilisticamente diverse che poi
          dominarono l&apos;intero secolo, chiamate armatura italiana/milanese e
          armatura tedesca. A Milano, la famiglia Missaglia divenne famosa per
        ...
        <p>
          A Praga, gli armaioli formarono un&apos;organizzazione nel 1328. Nel
          1329, un armaiolo di nome Klebel ottenne la cittadinanza della
          Citt&agrave; Vecchia, e dopo di lui altri 24 maestri si registrarono
          entro il 1393. Uno di essi, Henricus, proveniva nel 1354
          dall&apos;italiana Como, un altro da T&yacute;nec, Kol&iacute;n,
          Beroun o Chrudim. Nel 1351, Rudl fu registrato come il primo armaiolo
          tra i consiglieri della Citt&agrave; Vecchia. Durante le guerre
          hussite, l&apos;armaiolo V&uacute;z (1423) e l&apos;elmiere Jakub
          (1422) sono documentati tra i consiglieri della Citt&agrave; Vecchia.
          Entro il 1526, furono aggiunti altri 26 maestri armaioli, di cui uno
          (dopo il 1477) proveniva da Vlašim. Nei libri comunali, gli armaioli
          non sono rari e si trovano sempre tra i borghesi facoltosi, ma solo 4
          di entrambe le citt&agrave; praghesi si presentarono a prestare
          giuramento nel 1524. Abbiamo dunque i seguenti armaioli documentati
          per nome:{' '}
        </p>
        <ul>
          <li>
          ...
          <li>
            ...
            propriet&agrave; divenne bene demaniale nel 1463.
          </li>
          <li>Dal 1454: Janek Leg&aacute;t.</li>
          <li>Dal 1463: l&apos;armaiolo Voc&aacute;sek.</li>
          <li>Dal 1464: l&apos;armaiolo Smetana.</li>
          <li>Dal 1472: l&apos;armaiolo Škoda.</li>
          <li>Dal 1473: l&apos;armaiolo Duchek Popel.</li>
          <li>
        ...
        <p>
          Tra gli armaioli che erano abitanti non residenti della citt&agrave;,
          &egrave; documentato nel 1486 Jan Biberka, che fugg&igrave;
          ignominiosamente dalla Citt&agrave; Nuova. Dal 1454 &egrave; nota
          anche un&apos;armaiola di nome Kř&iacute;žov&aacute;
          <Qt
          ...
          />
          , probabilmente la moglie di Kř&iacute;ž.
        </p>
        <p>
        ...
        <p>
          ...
          cos&igrave; a Praga troviamo prima del 1419 anche tre elmieri
          (galeatores), due della Citt&agrave; Vecchia, di cui uno proveniva da
          ...
          />
          , chiamato <i>plechowicze</i> (in un documento del 1447).
    ...
    <Row>
      <Col>
        <h4>Protezione di testa e collo</h4>
        <p>
          L&apos;uomo armato portava tipicamente un collare a maglia, chiamato{' '}
          ...
          />
          Questo era solitamente seguito da un cappuccio tessile, alla fine del
          XV secolo tipicamente dotato di nappe, sopra il quale era posto
          l&apos;elmo. Tra gli elmi, il cappello di ferro, noto nel ceco
          dell&apos;epoca come <i>kapal&iacute;n</i>, e la celata derivata da
          ...
          complementati con una barbozza a piastre, nota nel ceco
