    ...
    <Row>
      <Col>
        ...
        <p>
          ...
          consiglio, ho deciso di creare per voi una guida semplice su come
          diventare rapidamente e senza sforzo un concorrente diretto dei
          Merlets e simili reliquie. (Ed &egrave; anche per questo che rimango
          nell&apos;anonimato pasticciero, capite &mdash; potrebbero voler
          vendicarsi!)
        </p>
        <p>
        ...
        <p>
          S&igrave;, il gruppo ovviamente ha bisogno di un nome! Avete diverse
          opzioni tra cui scegliere.
        </p>
        <ol type="a">
          <li>
            Un bel nome nella vostra lingua madre che evochi un&apos;atmosfera
          ...
          <li>
            ...
            sillabe, sei per ciascuna. Poi lanciate il dado tre volte e il
            vostro originale nome di gruppo &egrave; nato.
            <br />1 - <b>De ta um</b>
        ...
        <br />
        <h3>La scelta del comandante</h3>
        <p>
          Dovete avere un comandante &mdash; qualcuno che vi rappresenti, che
        ...
        <ol type="1">
          <li>
            <b>La taverna</b>
            <br />
            Chi non conosce la classica taverna medievale? Un&apos;ubriacatura
            di cavalieri e furfanti, piena di allegri scherzi, risse, duelli e
            acrobazie? I duelli possono avere ogni sorta di classici spunti per
            la trama:
            <ol type="a">
              <li>
              ...
              <li>
                <i>Quello &egrave; il mio calice!</i>
              </li>
              <li>
                <i>Derubiamolo!</i>
              </li>
              <li>
                <i>Quella &egrave; la mia borsa di monete.</i>
              </li>
              <li>
                <i>Quello &egrave; il mio pugnale.</i>
              </li>
            </ol>
            L&apos;unica risposta appropriata &egrave;:{' '}
            <i>
              &ldquo;Vieni a prendertelo, (brutto sudicio / villano / cane /
              codardo &mdash; cancella ci&ograve; che non si applica)!&rdquo;
            </i>
            <br />
            La comicit&agrave; consiste principalmente nel cadere a terra, fare
            il broncio, strabuzzare gli occhi e prendere a calci i sederi.
            Combinando questi elementi potete riempire il tempo
            dell&apos;esibizione per quanto vi serve (cio&egrave; siete
            flessibili alle esigenze dell&apos;organizzatore &mdash; non
            dimenticate di inserirlo nel vostro materiale promozionale!)
            <br />
            L&apos;esibizione si conclude invariabilmente con l&apos;arrivo
            della moglie dalla lingua affilata del taverniere con una scopa, che
            spazza via tutti dal palco con il grido occasionale di:{' '}
          ...
          <li>
            <b>Conferenza sulle armi e l&apos;armatura</b>
            <br />
            Un&apos;esibizione adatta per le scuole, o quando siete troppo
            pochi, o semplicemente non avete voglia di sforzarvi. Il vantaggio
            di questa esibizione &egrave; che due artisti possono gestirla
            facilmente; in casi critici, basta uno solo. Non sapete niente di
            storia? Non importa. Sicuramente uno dei vostri membri ha
            un&apos;enciclopedia dove potete trovare qualcosa. Se no, chiedete
            al vostro professore di storia (ne sa tanto poco quanto voi, ma per
            salvare la faccia inventer&agrave; qualcosa). Poi lo scrivete su un
            pezzo di carta, bruciacchiate i bordi con un accendino, e via
            all&apos;esibizione che introdurr&agrave; il pubblico alla storia
            della guerra medievale in modo divertente e istruttivo.
            <br />
            &Egrave; bene aprire la conferenza affermando che anche gli uomini
            delle caverne si prendevano a bastonate in testa. Questo
            catturer&agrave; sicuramente il pubblico. Poi potrete dilungarvi
            eloquentemente su spade, spadoni, flagelli, bastoni e pugnali.
            Sparate i secoli a caso &mdash; pi&ugrave; o meno due secoli
            &egrave; nella norma; nessuno star&agrave; ascoltando comunque.
            &Egrave; bene concludere con il presente. Una battuta spiritosa
            sulle danze con le spade non guaster&agrave;! Inframmezzerete la
          ...
          <li>
            <b>L&apos;addestramento</b>
            <br />
            Essenzialmente molto simile alla conferenza, tranne che ci sono
            pi&ugrave; artisti, interpretano delle reclute, e il comandante si
            mette in mostra davanti a loro. Li ferma nel mezzo di un duello con
            le parole:{' '}
            <i>
              &ldquo;Non cos&igrave;, pivello &mdash; impugni la spada troppo
              forte!&rdquo;
            </i>{' '}
            ...
            <i>
              ...
              pieni di erbacce, canaglia!&rdquo;
            </i>{' '}
            caccia gli artisti dal palco.
            <br />
            Segue il meritato applauso.
            <br />
            <br />
          ...
          <li>
            ...
            <ol type="a">
              ...
              <li>
                Una donna arriva con una scopa e con il grido:{' '}
                <i>
                  &ldquo;Che sono tutti questi combattimenti, canaglia? Devo
                  pulire qui!&rdquo;
                </i>{' '}
                caccia tutti dal palco con la scopa. L&apos;ultimo a essere
                sottomesso &egrave; il temibile guerriero (il pubblico trova
                sempre questo molto divertente).
              </li>
            </ol>
            Segue il meritato applauso.
          </li>
        ...
        <h3>La musica</h3>
        <p>
          La musica deve accompagnare l&apos;esibizione, e non vi lascer&ograve;
          senza consiglio nemmeno qui. Le colonne sonore dei film sono le
          migliori &mdash; qualsiasi andr&agrave; bene. Ma siccome avete
          gi&agrave; esibizioni classiche, vi consiglierei musica classica per
          accompagnarle. Ecco una top 6:
        </p>
        <ol>
          <li>
            Vangelis, Conquest of Paradise &#8211; numero uno. Con questa non
            potete mai sbagliare.
          </li>
          <li>
            Conan il Barbaro + Conan il Distruttore &#8211; un classico
            assoluto, che offre molte atmosfere, suoni misteriosi e musica
            eroica. Una necessit&agrave; assoluta.
          </li>
          <li>
            Carmina Burana &#8211; la scelta ovvia per un torneo o qualsiasi
            pezzo con un cavaliere. Sostituisce l&apos;armatura a piastre al 50
            percento.
          </li>
          <li>
          ...
          <li>
            ...
            voi potete raccogliere un po&apos; della gloria del signor Depp.
            Imitatelo e godetevi il meritato applauso.
          </li>
          <li>
        ...
        <br />
        <h3>Materiale promozionale</h3>
        <p>
          Serve a far conoscere la vostra esistenza al grande pubblico e,
          soprattutto, agli organizzatori di eventi. Il mezzo di promozione
          pi&ugrave; comune e pi&ugrave; efficace &egrave; un sito web.
          Sicuramente uno dei vostri membri ha qualche dimestichezza con HTML
          Kit o qualche programmino simile, quindi avanti! L&apos;importante
          &egrave; creare un&apos;atmosfera medievale. Per questo userete GIF
          animate &mdash; torce fiammeggianti, teschi con occhi lampeggianti, o
          una combinazione di entrambi sono particolarmente graditi. Rubatele
          dal sito di qualche gruppo heavy metal e copiatele quante pi&ugrave;
          volte possibile. Nella homepage, scrivete:{' '}
          <i>&ldquo;Benvenuto, stanco viandante!&rdquo;</i> in un carattere
          illeggibile.
        </p>
        <p>
          ...
          citazione del suddetto personaggio fantasy preferito e un motto di
          vita. Chi non riesce a pensarne uno dovrebbe usare Carpe Diem!
        </p>
        <p>
          La sezione successiva sar&agrave; <b>Esibizioni</b>. Dovete scattare
          foto promozionali. Non deve essere in un castello (noi non facciamo
        ...
        <p>
          ...
          troppo caro! Lunga vita alla scherma!
        </p>
        <p className="text-end">Vostro, Cialdone</p>
      </Col>
    </Row>
  </>
)
