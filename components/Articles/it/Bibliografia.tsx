...
export const Bibliografia = ({ draft }: ArticleProps) => (
  <>
    <Row>
      <Col>
        <h1>Fonti{draft && <DraftBadge />}</h1>
        <h2>Primarie</h2>
        <h3>Boeme</h3>
        <ul>
          <li>
            <a
              ...
              target="_blank"
            >
              Památná kniha olomoucká (Libro memoriale di Olomouc)
            </a>
          </li>
          <li>
            <a
          ...
          <li>
            <a
              ...
              target="_blank"
            >
              Pala d&apos;altare di San Giorgio (Svatojiřský oltář)
            </a>
          </li>
          <li>
            <a
              ...
              target="_blank"
            >
              Pala d&apos;altare dell&apos;Arca di Puchner (Puchnerova archa)
            </a>
          </li>
          <li>
            <a
              ...
              target="_blank"
            >
              Ali di pala d&apos;altare da Roudníky (Oltářní křídla z Roudník)
            </a>
          </li>
          <li>
            <a
              ...
              target="_blank"
            >
              Bibbia di Kutná Hora (Kutnohorská Bible)
            </a>
          </li>
          <li>
            <a
              ...
              target="_blank"
            >
              Antithesis Christi et Antichristi (Codice di Jena)
            </a>
          </li>
        </ul>
      </Col>
        ...
        <ul>
          <li>
            <a
              ...
              target="_blank"
            >
              Chronicon Concilii Constantiensis (Piccola Cronaca di Richental)
            </a>
          </li>
          <li>
            <a
        ...
        <ul>
          <li>
            <a
              ...
              target="_blank"
            >
              La produzione della pelle nelle terre ceche nel Medioevo
          ...
          <li>
            <a
              ...
              target="_blank"
            >
              La trasformazione degli stili di abbigliamento durante le guerre
              hussite (Proměna stylu odívání v průběhu husitských válek)
            </a>
          </li>
          <li>
            <a
              ...
              target="_blank"
            >
              La pala d&apos;altare di Rakovník (Rakovnický oltář)
            </a>
          </li>
          <li>
            <a
              ...
              target="_blank"
            >
              Articoli delle corporazioni praghesi (Artikule cechů pražských)
            </a>
          </li>
          <li>
            <a
              ...
              target="_blank"
            >
              Decorazione ad affresco del castello di Žirovnice (Fresková
              výmalba zámku v Žirovnici)
            </a>
          </li>
          <li>
            <a
              ...
              target="_blank"
            >
              Atti del Museo Hussita di Tábor (Battaglia di Schönberg 1504)
            </a>
          </li>
        </ul>
      </Col>
        ...
        <ul>
          ...
          <li>
            <a
              ...
              target="_blank"
            >
              Lapide tombale di Vilém di Ilburk, dopo il 1489
            </a>
          </li>
          <li>
            <a href="https://www.esbirky.cz/predmet/7592512" target="_blank">
              Dipinto su tavola bifacciale della Cattura di Cristo, ca. 1500
            </a>
          </li>
          <li>
            <a href="https://www.esbirky.cz/predmet/3510952" target="_blank">
              Epitaffio di Půta Švihovský di Rýzmberk, 1504
            </a>
          </li>
        </ul>
      </Col>
