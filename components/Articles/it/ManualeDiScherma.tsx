...
export const ManualeDiScherma = ({ draft }: ArticleProps) => (
  <>
    ...
    <Row>
      ...
      <Col md={6}>
        ...
        <p>
          ...
          poter escogitare tutto ci&ograve; che sa essergli utile &ndash; che si
          tratti di armi insolite o di astuzie e vantaggi abili. Poich&eacute;
          colui che viene sfidato sceglie le armi e pu&ograve; farle come
          desidera.
          <br />
          Per esempio: due uomini devono combattere tra loro, uno &egrave;
          mancino e l&apos;altro destro. Il destro sfida il mancino. Il mancino
          sceglie dunque le armi come segue: due stocchi affilati e due pugnali
          affilati. Inoltre, due bracciali (armschirleinn), uno per ciascun
          combattente sul braccio destro, poich&eacute; la mano destra del
          mancino &egrave; meno abile, e all&apos;interno di ciascun bracciale,
          alla piega, vi &egrave; una punta affilata, cosicch&eacute; quando
          qualcuno piega anche solo leggermente quel braccio, la punta lo
          trafigge.
          <br />
          Quando arrivano al luogo stabilito e ricevono le armi, ciascuno
          indossa il bracciale sul braccio destro come indicato. Una volta che
          devono entrare in combattimento, il destro non pu&ograve; difendersi
          &ndash; non appena piega il braccio, si trafigge da solo.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col md={6}>
        <p>
          ...
          fornisce le armi ha sempre il vantaggio maggiore. Ho raccontato
          ci&ograve; affinch&eacute; chiunque desideri sfidare un altro a
          combattimento sia consapevole di tali astuzie e non agisca
          impulsivamente per rabbia, ma offra la sfida con calma deliberazione
          &ndash; cos&igrave; come &egrave; stato anche consuetudine che due
          uomini si accordino se combattere in armatura completa, oppure senza,
          o con armi di propria scelta.
          <br />
          Per quanto riguarda il combattimento o la lotta senza armatura e quali
          vantaggi vi siano e come usarli, questo &egrave; gi&agrave; stato
          insegnato sufficientemente nello stocco e nelle altre armi e ben
          compreso. Ora desidero soltanto descrivere i vantaggi nella scherma in
          armatura, come usarli e applicarli. E si noti che tre armi sono
          comunemente usate nel combattimento in armatura: una lancia e una
          spada, inoltre un pugnale &ndash; oppure un pugnale e una sciabola
          cinta alla vita, e una spada.
          <br />
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col md={6}>
        <p>
          La prima disposizione delle armi per il combattimento in armatura
          &egrave; questa: una lancia, una spada e un pugnale da combattimento o
          un pugnale, oppure anche uno scudo. Nell&apos;attacco si usavano lo
          scudo e la lancia e si lavorava con la lancia &ndash; ad esempio, per
          far cadere l&apos;avversario facendogli lo sgambetto, oppure si
          lanciava la lancia e poi si inseguiva, poich&eacute; in tempi antichi
          il lancio della lancia era pratica molto diffusa. Dopo aver lanciato
          le lance, si impugnava la spada e poi il pugnale o il pugnale da
          combattimento.
          <br />
    ...
    <Row>
      ...
      <Col md={6}>
        <p>
          ...
          liberato e riutilizzato. Ma deve essere costruito in modo che le molle
          non siano visibili, cosicch&eacute; guardando l&apos;arma non siano
    ...
    <Row>
      ...
      <Col>
        <p>
          Fai attenzione che non ti sorprenda con un colpo fulmineo e lascia che
          colpisca a vuoto per primo. Ricorda: quando ti sferra un colpo, devi
          ...
          dita, ovvero laddove qualcuno ti afferra, vedi se riesci ad afferrare
          un dito e spezzare la presa.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          ...
          esempi, e poi descrivere i vantaggi delle armi summenzionate.
          <br />
          All&apos;ingresso in combattimento, prendi la spada nella guardia alta
          (Oberhut), entrambe le mani accanto alla testa, e afferra la lama a
          met&agrave; con la mano sinistra cosicch&eacute; la punta sia rivolta
          ...
          con la mano sinistra. Se poi colpisce dall&apos;alto, intercetta il
          suo colpo tra entrambe le tue mani e nel frattempo affonda
          dall&apos;esterno sopra il suo braccio alla gola.
          <br />
        </p>
      </Col>
    </Row>
    ...
    <Row>
      ...
      <Col>
        <p>
          ...
          dove puoi, e allontanalo da te. Oppure porta il pomolo intorno al suo
          collo, avanza con il piede destro dietro la sua gamba e gettalo a
          terra. Inoltre intercetta il suo colpo dalla guardia e spingi verso
          l&apos;alto con l&apos;elsa e affonda alla sua gola o alle aperture
          vicino alle
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          ...
          correttamente, non pu&ograve; agire efficacemente. <br />
          Controtecnica: se qualcuno ha puntato contro di te, affonda
          dall&apos;alto sopra il suo braccio destro, passando sotto la sua
          spada, e premi il pomolo verso il basso verso terra. Non appena
          rilascia, spingi la tua spada in avanti sotto il suo braccio destro e
          con il piede destro avanza dietro il suo sinistro, e con la mano
    ...
    <Row>
      ...
      <Col>
        <p>
          ...
          <br />
          Un altro modo: prendi il suo braccio destro tra le sue gambe,
          distenditi trasversalmente su di lui e tieni le gambe saldamente
          unite.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          e distenditi saldamente, e con la mano sinistra afferra il suo braccio
          sinistro e tienilo fermo, e lavora con il pugnale come seguir&agrave;
          in seguito.
        </p>
        <h4>Come si devono usare le tre armi summenzionate</h4>
        <p>
    ...
    <Row>
      ...
      <Col>
        <h4>La seconda tecnica</h4>
        <p>
          Ricorda: avanza verso di lui in guardia alta, afferra la presa vicino
          al pomolo e con la mano sinistra afferra la lama presso l&apos;elsa a
          croce, e affonda con forza (knefftiglich) verso la sua visiera. Tira
          indietro verso di te e affonda con forza dal basso verso il suo
          inguine cosicch&eacute; non osi avvicinarsi troppo.
          <br />
          Poi ritira la tua arma e con la mano sinistra afferra il primo terzo
          della tua lama. Se preme su di te, arretra &ndash; ci&ograve; lo
          porter&agrave; a sbilanciarsi e presto colpir&agrave;. Non lasciare
          che ti raggiunga, ma schiva di lato. Se ha colpito e manca, rilascia
          la mano destra e portala in aiuto alla sinistra, e colpiscilo
          sull&apos;elmo o sull&apos;arto pi&ugrave; vicino.
          <br />
          Se, tuttavia, non ha colpito, allora colpiscilo sul ginocchio o sulla
          caviglia. Se para, spingi verso l&apos;alto con entrambe le braccia,
          colpiscilo sulla giuntura superiore e riprendi la presa con entrambe
          le mani.
          <br />
    ...
    <Row>
      ...
      <Col>
        <p>
          ...
          <br />
          Avvicinati anche a lui in guardia bassa, fingi e minaccialo con un
          affondo. Nel frattempo rilascia la presa, gira intorno al suo lato
          sinistro, afferra la lama con entrambe le mani e lancia il becco
          dell&apos;elsa a croce nell&apos;anca sotto la sua corazza con forza
          nella maglia.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          Inoltre affonda in guardia bassa verso l&apos;inguine, tira indietro e
          ...
          ogni volta che vedi un vantaggio, non lasciarlo passare inutilmente.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          ...
          gelertt / mit was listen dz gesichtict <br /> so mag er sein Sebell
          nit geziehenn das ist auch der fortheill mit dem Sebell
        </p>
      </Col>
      <Col>
        <p>
          Ora avvicinati a lui e punta contro di lui con posizione salda dalla
          guardia alta, e affonda con forza nella sua visiera. Se si difende
          verso l&apos;alto e cerca di deviare, tira di lato e affondagli sotto
          il braccio sinistro. Assicurati di stare saldamente e di non
          sbilanciarti con il peso. Ricorda: non appena la tua punta tiene
          ...
          indietro rapidamente e punta sotto l&apos;ascella destra. E ricorda:
          quando cos&igrave; lo afferri puntando sotto l&apos;ascella destra e
          anche con il braccio sotto la tua ascella sinistra come insegnato in
          precedenza &ndash; con quale astuzia ci&ograve; viene fatto &ndash;
          allora non pu&ograve; estrarre la sciabola. E questo &egrave; anche il
          vantaggio della sciabola.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          E quando ti colpisce al ginocchio, para con la met&agrave; della tua
          lama dietro la sua elsa a croce, afferra la sua spada contro la tua e
          spingi il pomolo nella piega del suo ginocchio. Tiralo verso di te e
          allontanalo con la mano sinistra.
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          Inoltre affonda simultaneamente con lui dall&apos;interno, dal tuo
          ...
          sopra il braccio sinistro, e sferragli un colpo in legatura
          ...
          avanza con il piede sinistro e allontanalo da te.
        </p>
      </Col>
    </Row>
    <Row>
    ...
    <Row>
      ...
      <Col>
        <p>
          cerca di afferrare la sua sciabola o la tua spada, afferra la sua mano
          destra con la tua sinistra, tirala verso di te, torcigli verso il
          basso e colpisci con la sciabola alla sua giuntura del gomito e
          rompigli il braccio.
          <br />
          ...
          fessure; e con il pomolo, indebolisci, rompi e martella le giunture e
          gli arti, e inoltre punta contro di lui. Ma se la tua
        </p>
      </Col>
    </Row>
    <Row>
      ...
      <Col>
        <p>
          spada &egrave; stata presa o ne sei stato separato, devi lavorare con
          la sciabola e avvicinarti con la lotta, e colpire con il pomolo sotto
          i suoi occhi, e vedi se riesci ad agganciare o fare lo sgambetto alla
          sua gamba.
          <br />
          Inoltre, se hai perso la spada e l&apos;avversario ha estratto
    ...
    <Row>
      ...
      <Col>
        <p>
          ...
          ginocchio e rompigli le braccia. Cadi anche sulle fibbie
          dell&apos;armatura sulla schiena.
          <br />
          Quando lo hai gettato a terra, trafiggi nel terreno e riempigli la
          visiera, oppure taglia qualcosa dal suo sopravveste e blocca la sua
          visiera. Poi lavora con il pugnale all&apos;inguine, o tra le
          giunture, oppure affonda al cuore, o alle giunture ovunque esse siano.
          <br />
          Infine si noti che, poich&eacute; &egrave; accaduto che talvolta le
          stesse tecniche appaiano in varie armi, per brevit&agrave;, dove
          qualcosa era stato stabilito per un&apos;arma, l&apos;ho omesso in
          un&apos;altra, purch&eacute; ci&ograve; potesse essere fatto senza
          danno alla comprensione &ndash; cosicch&eacute; non ripetessi
