...
export const AdamoEnricoDiEinsiedl = () => (
  <>
    <Row>
      <Col>
        <div className="anchor" id="adamo-enrico-di-einsiedl" />
        <h4>
          Adam Jindřich (Adamo Enrico) Týřovský di Einsiedl (morto nel 1652)
        </h4>
        <p>
          Alla morte del padre nel 1618 Adam Jindřich era minorenne, il che
          probabilmente lo salvò. Nel 1621 fu sì convocato davanti alla
          commissione delle confische, ma poiché non aveva ancora l&apos;età
          legale non si presentò a una duplice convocazione; solo nel 1629 fu
          assolto davanti alla commissione tractationis, poiché non aveva preso
          parte personalmente alla rivolta, e i beni paterni di Chříč,
          Hřebečníky, Broumy e Kožlany gli furono lasciati.
          <Qt
        ...
        <p>
          Il suo tutore Bohuslav Jiří Krakovský nel frattempo amministrava male
          Chříč. Nel 1624 Dorota Týřovská lo denunciò, sostenendo che impoveriva
          gli orfani e che aveva portato via e venduto grano, bestiame e altre
          cose.
          <Qt
            publication={PUBLICATIONS.KOCKA1}
            href="https://kramerius5.nkp.cz/view/uuid:cbd24070-4608-11ed-b64c-005056827e52?page=uuid:7e24d610-e020-4b49-94be-10a7485249aa"
        ...
        <p>
          Nel 1627 Adam Jindřich raggiunse la maggiore età e prese possesso dei
          beni indebitati; li amministrava con il funzionario Václav Kulíšek.
          Per poter coltivare la tenuta devastata prese in prestito 2800
          sexagene da Vilém di Klenové, signore di Zvíkovec. Quando nel 1631 il
        ...
        <p>
          Nello stesso anno 1631 i Sassoni irruppero a Rakovník e il Týřovský fu
          in seguito accusato di aver accolto in piazza il capitano Ploskovský,
          di essersi offerto a lui come capitano di cavalleria, di aver percorso
          la regione con la moglie, di aver fornito notizie ai Sassoni, di
          essersi scontrato con gli imperiali e di aver minacciato la cattolica
          Plzeň. I borghesi di Rakovník testimoniarono invece che non era stato
        ...
        <p>
          La guerra si riversò su Chříč ancora due volte. Nel 1637 eserciti
          nemici si aggiravano nei dintorni e incendiarono Chříč, cosicché Adam
          Jindřich soggiornava a Praga, dove comprò una casa dal registratore
          delle imposte Kačerovský. Nel marzo del 1640 il colonnello imperiale
          Václav Zahrádecký giunse con due reggimenti a Podmokly, bruciò ogni
          cosa e si lanciò attraverso il guado verso Chříč; il Týřovský raccolse
          300 fiorini di riscatto contro l&apos;incendio e si liberò così del
          nemico.
          <Qt
            publication={PUBLICATIONS.KOCKA1}
            href="https://kramerius5.nkp.cz/view/uuid:cbd24070-4608-11ed-b64c-005056827e52?page=uuid:7c883e9c-c039-4e28-8217-2e3df2340137"
