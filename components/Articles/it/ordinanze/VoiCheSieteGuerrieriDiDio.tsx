    ...
    <Row>
      <Col>
        <p>
          ...
          grazia.
          <br />
          5a strofa: non temete il numero dei nemici e non fuggite dalla
          battaglia. <br />
          6a strofa: se il comandante è capace, la campagna andrà a buon fine.
          <br />
          7a strofa: non uccidete per saccheggiare e non fermatevi per il
          bottino.
          <br />
    ...
    <Row>
      <Col md={6}>
        ...
        <p>
          ...
          <br />a pred neprzately neutiekayte
        </p>
        <p>
      ...
      <Col md={6}>
        <p>
          <b>Voi che siete guerrieri di Dio</b>
          <br />
          <br />
        </p>
        <p>
