  ...
  <>
    <Row>
      <Col>
        <div
          className="anchor"
          id="istruzione-del-margravio-sulla-formazione-dei-carri"
        />
        <h4>
    ...
    <Row>
      ...
      <Col md={6}>
        <ol>
          ...
          <li>
            Ciascun carro deve avere due pale, un piccone, un&apos;ascia e una
            zappa.
          </li>
          <li>
            Due steccati l&apos;uno di fronte all&apos;altro e sopra di essi un
