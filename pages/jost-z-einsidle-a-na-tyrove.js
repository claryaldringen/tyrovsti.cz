...
const Page = () => (
  <>
    ...
    <Container>
      <Row>
        <Col className="text">
          <h1>Jošt z Einsiedle a na Týřově</h1>
          <h2>Životopis</h2>
          <p>
          ...
          <p>
            ...
            působnosti. Protože Jiří rozuměl, jak známo, jen málo německy, byl
            pro něho jeho tajný písař doslova nepostradatelný. Proto ho najdeme,
            pokud nebyl nepřítomen z důvodu vykonávání nějakého poslání, stále
            na straně zemského správce, kterého doprovází na jeho velkých
            ...
            vyžadovaly zcela zvláštní péči a spolehlivost.
          </p>
          <p>
          ...
          <p>
            ...
            Jošt tuto významnou událost s neskrývanou radostí a sdělil to ihned
            do Chebu, kde byla tato zpráva radostně přijata (zachovala se pouze
            odpověď z Chebu). Protože se Jiří proslavil již v dřívějších letech
            horlivou péčí o udržení míru, muselo být pro město jako Cheb, které
            leželo na hranicích různých oblastí a provozovalo čilý obchod, jeho
            zvolení obzvláště žádoucí. Nadto ujistil Jošt chebské měšťany
            královou přízní a napomínal je, aby ani trochu nedbali pomluv a
            hrozeb svých sousedů, nýbrž zůstali pevní a neochvějní.
          </p>
          <p>
          ...
          <p>
            Aby však král mohl splatit svůj dluh pražskému purkrabímu Zdeňkovi
            ze Šternberka, vrátil mu Jošt výše zmíněné dědictví a k tomu půjčil
            ještě hotově 500 kop grošů, za které zapsal mu král roku 1460 hrad
            Týřov s městečkem Kožlany, vsi Mlečice Chmelištnou, Zavidov,
            ...
            k palivu a na opravy hradu. V lovu drobné zvěře a ptáků měl Jošt
            svobodu, kdežto z vysoké zvěře směl štvát 3 jeleny a 10 srn do roka
            s vědomím křivoklátského purkrabího, který mu byl povinnen půjčit
            psy a tenata.
          </p>
          <p>
            Poněvadž hrad potřeboval opravy hradeb, podsebití i budov, připsal
            král Joštovi na opravu 100 kop grošů. Kdyby byl hrad Joštovi dobyt,
          ...
          <p>
            ...
            <i>„ad relationem Jodoci de Eynsedel secr.”</i> Město potřebovalo
            asi také ohledy krále, protože v důsledku své exponované polohy bylo
            osočováno jednou z té, podruhé z oné strany. Takže mělo kromě
            častých přespolních sporů také hádky s vlastními zemědělskými
            usedlíky, kteří chtěli uvolnit právní svazek s městem, jakož i
            problémy s opatem z Waldsassenu kvůli soudní pravomoci v několika
            vesnicích, které byly stejně jako Albenreuth (dnes Mýtina, část obce
            Lipová) obydleny klášterními i městskými poddanými. Jošt byl tedy
            často žádán o přímluvu. Ten byl ochotný podat informace, pokud se
            nejednalo o úřední tajemství, které vždy rozhodně zachovával. Ale
            také jinak jedná s velkou opatrností, a jakkoli je tato rovněž
            chvályhodná, překvapí nepříjemně čtenáře, když např. uprostřed
            zajímavého dopisu stojí:
            <i>
              „A jakkoli se sami chcete dovědět důvod téže záležitosti, můžete
              sem poslat jednoho z přátel rady, který je mi znám, a dozvíte se
              celou věc důkladně”
            </i>
            .
          </p>
          ...
          <p>
            ...
            po ukončení jednání odcházelo z Chebu, převzal dar 100 kop grošů od
            města pro krále:
            <i>
              „Tím jsme poukázali našemu panu králi opět 1 kopu grošů, aby ho
              rada uctila - předáno pánu Joštu z Einsiedle”
            </i>
          </p>
          <p>
            ...
            <i>
              ...
              moci mnoho spát, jelikož má spoustu práce a stále bude muset dlít
              v blízkosti krále”
            </i>
            .
          </p>
          <p>
            V důsledku této diplomatické činnosti získal Jošt z Eisiedle široký
            ...
            <i>
              „ve velké tajnosti říci našemu pánu králi, neboť je to skutečně
              tak”
            </i>{' '}
          ...
          <p>
            ...
            Gery, z příkazu krále jako prostředník ve sporu mezi Jindřichem z
            ...
            také Jošt z Einsiedle na Týřově, přenosem státních listin
            uchovávaných na Karlštejně do Prahy a jejich kontrolou.
          </p>
          <p>
          ...
          <p>
            Nakonec však propukly v nezadržitelném sledu události, kvůli kterým
            vyhasla klesající hvězda Jiřího. Klatba, která ho potkala,
            zachvátila také jeho věrné, a celé kraje úpěly pod tíží interdiktu.
            Také město Cheb, které svému králi zachovalo chvályhodnou věrnost,
            propadlo církevnímu trestu. Nehledě na sympatie, které mělo k osobě
            krále (již 4. září 1461 mu přísahalo věrnost), převážily zde
            rozhodně politické důvody. Od roku 1315 bylo město Cheb se svou
            oblastí zástavním majetkem české koruny. Opíraje se o svá
            privilegia, která mu vymezila výhodné zvláštní postavení, drželo se
            stranou všech hnutí v Čechách a skládalo přísahu a vzdávalo hold
            pouze korunovanému králi. Vzdát hold králi, který jako Matyáš neměl
            korunu, by mohlo mít lehce za následek nebezpečný precedens. Proto
            město, bez ohledu na opakovaná napomenutí, odepřelo vzdorokráli hold
            a nechalo spíše nad sebou vyhlásit interdikt.
          </p>
          <p>
            Že ani Jošt nezakolísal, je po všem, co bylo již řečeno, snadno
            pochopitelné. Jako muž se svědomím a charakterem zachoval věrnost
            svému králi, aniž by také jen v nejmenším porušil ponižující
            poslušnost vůči trestající církvi. Přes jeho rty neprojde ani slovo
            výčitky, přesto musí vytrpět všechny obtíže; neboť jako katolík má
            za nepřátele utrakvisty a jako přívrženec exkomunikovaného krále
            vlastní souvěrce, z jejichž společenství ho přece církev vyloučila.
            Jeho statky jsou pustošeny, jeho poddané vesnice páleny a ničeny
            (svou škodu vyčísluje na 300 kop grošů). Král Jiří škodu uznává a a
            roku 1466 mu připisuje 100 kop grošů na stavbu rybníků a uděluje
            ...
            jsou bez přestání v konfliktu: ostrý boj, který hýbal celou dobou,
            se odráží v prsou tohoto muže, který se s rozhodností přidržuje
            toho, co ve své prosté duši považuje za správné a dobré. Nakonec se
            rozhodne pro trpící poslušnost, protože mu jde o víru, kterou nechce
            vzdorovitostí
            <i>„pomoci oslabit”</i>. Takto sdílí stejný osud se spřáteleným
            městem Cheb, které se snaží utěšovat a posilovat v poslušnosti.
            Teprve když vidí, že jeho protivníkům nejde ani tolik o víru jako
            spíše o kořist, chopí se meče a sjedná si klid.
          </p>
          <p>
            Po smrti krále Jiřího se smíří s Matyášem a jeho přívrženci, jak to
            učiní také město Cheb, a je rozhodnut uznat za krále toho, kdo podle
            starého zvyku získá korunu. Proto ho vidíme také v okolí Vladislava,
            který ho rovněž přijímá do svých služeb. Roku 1472 získává od krále
            Vladislava pro Kožlany městská práva stejná jako má Rakovník, erb a
            povolení vystavět v Kožlanech pivovar. Roku 1473 postoupil mu král
          ...
          <ul>
            <li>
              Franz Kürschner:
              <i>
                Jobst von Einsiedel und seine Correspondenz mit der Stadt Eger.
